...
@ApplicationScoped
public class EmployeeJUP0HAGIService {

    @ConfigProperty(name="employee.soap.url")
    private String employeeSoapUrl;

    @Named
    public CxfEndpoint employeeServiceEndpointJUP0HAGI_getEmployeeById() {
    ...
    @Named
    public CxfEndpoint employeeServiceEndpointJUP0HAGI_getEmployeesByName() {
        CxfEndpoint cxfEndpoint = new CxfEndpoint();
        cxfEndpoint.setServiceClass(EmployeeServicePortType.class);
        cxfEndpoint.setAddress(employeeSoapUrl);
        cxfEndpoint.setWsdlURL(null);
