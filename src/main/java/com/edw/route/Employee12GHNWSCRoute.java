...
@ApplicationScoped
public class Employee12GHNWSCRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_12GHNWSC/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_12GHNWSC")
            .get("/employees_12GHNWSC/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_12GHNWSC");
        // get one employee
        from("direct:get-employee_12GHNWSC")
                .routeId("get-employee-api_12GHNWSC")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint12GHNWSC_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_12GHNWSC")
                .routeId("get-employees-by-firstname-lastname-api_12GHNWSC")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint12GHNWSC_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
