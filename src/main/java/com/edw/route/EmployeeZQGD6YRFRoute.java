...
@ApplicationScoped
public class EmployeeZQGD6YRFRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_ZQGD6YRF/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_ZQGD6YRF")
            .get("/employees_ZQGD6YRF/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_ZQGD6YRF");
        // get one employee
        from("direct:get-employee_ZQGD6YRF")
                .routeId("get-employee-api_ZQGD6YRF")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointZQGD6YRF_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_ZQGD6YRF")
                .routeId("get-employees-by-firstname-lastname-api_ZQGD6YRF")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointZQGD6YRF_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
