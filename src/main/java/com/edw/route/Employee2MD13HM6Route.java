...
@ApplicationScoped
public class Employee2MD13HM6Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_2MD13HM6/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_2MD13HM6")
            .get("/employees_2MD13HM6/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_2MD13HM6");
        // get one employee
        from("direct:get-employee_2MD13HM6")
                .routeId("get-employee-api_2MD13HM6")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint2MD13HM6_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_2MD13HM6")
                .routeId("get-employees-by-firstname-lastname-api_2MD13HM6")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint2MD13HM6_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
