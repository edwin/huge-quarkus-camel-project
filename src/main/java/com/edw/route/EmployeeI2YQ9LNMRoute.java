...
@ApplicationScoped
public class EmployeeI2YQ9LNMRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_I2YQ9LNM/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_I2YQ9LNM")
            .get("/employees_I2YQ9LNM/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_I2YQ9LNM");
        // get one employee
        from("direct:get-employee_I2YQ9LNM")
                .routeId("get-employee-api_I2YQ9LNM")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointI2YQ9LNM_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_I2YQ9LNM")
                .routeId("get-employees-by-firstname-lastname-api_I2YQ9LNM")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointI2YQ9LNM_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
