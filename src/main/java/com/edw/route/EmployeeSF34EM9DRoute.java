...
@ApplicationScoped
public class EmployeeSF34EM9DRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_SF34EM9D/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_SF34EM9D")
            .get("/employees_SF34EM9D/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_SF34EM9D");
        // get one employee
        from("direct:get-employee_SF34EM9D")
                .routeId("get-employee-api_SF34EM9D")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointSF34EM9D_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_SF34EM9D")
                .routeId("get-employees-by-firstname-lastname-api_SF34EM9D")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointSF34EM9D_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
