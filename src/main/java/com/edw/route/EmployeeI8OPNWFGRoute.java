...
@ApplicationScoped
public class EmployeeI8OPNWFGRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_I8OPNWFG/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_I8OPNWFG")
            .get("/employees_I8OPNWFG/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_I8OPNWFG");
        // get one employee
        from("direct:get-employee_I8OPNWFG")
                .routeId("get-employee-api_I8OPNWFG")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointI8OPNWFG_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_I8OPNWFG")
                .routeId("get-employees-by-firstname-lastname-api_I8OPNWFG")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointI8OPNWFG_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
