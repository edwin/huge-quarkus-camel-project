...
@ApplicationScoped
public class Employee570G56NGRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_570G56NG/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_570G56NG")
            .get("/employees_570G56NG/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_570G56NG");
        // get one employee
        from("direct:get-employee_570G56NG")
                .routeId("get-employee-api_570G56NG")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint570G56NG_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_570G56NG")
                .routeId("get-employees-by-firstname-lastname-api_570G56NG")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint570G56NG_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
