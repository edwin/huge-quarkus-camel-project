...
@ApplicationScoped
public class EmployeeQ8KN84Q8Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_Q8KN84Q8/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_Q8KN84Q8")
            .get("/employees_Q8KN84Q8/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_Q8KN84Q8");
        // get one employee
        from("direct:get-employee_Q8KN84Q8")
                .routeId("get-employee-api_Q8KN84Q8")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointQ8KN84Q8_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_Q8KN84Q8")
                .routeId("get-employees-by-firstname-lastname-api_Q8KN84Q8")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointQ8KN84Q8_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
