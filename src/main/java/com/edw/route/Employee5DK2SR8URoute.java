...
@ApplicationScoped
public class Employee5DK2SR8URoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_5DK2SR8U/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_5DK2SR8U")
            .get("/employees_5DK2SR8U/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_5DK2SR8U");
        // get one employee
        from("direct:get-employee_5DK2SR8U")
                .routeId("get-employee-api_5DK2SR8U")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint5DK2SR8U_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_5DK2SR8U")
                .routeId("get-employees-by-firstname-lastname-api_5DK2SR8U")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint5DK2SR8U_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
