...
@ApplicationScoped
public class EmployeeJ6STW9MPRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_J6STW9MP/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_J6STW9MP")
            .get("/employees_J6STW9MP/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_J6STW9MP");
        // get one employee
        from("direct:get-employee_J6STW9MP")
                .routeId("get-employee-api_J6STW9MP")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointJ6STW9MP_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_J6STW9MP")
                .routeId("get-employees-by-firstname-lastname-api_J6STW9MP")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointJ6STW9MP_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
