...
@ApplicationScoped
public class EmployeeRJCSINJ2Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_RJCSINJ2/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_RJCSINJ2")
            .get("/employees_RJCSINJ2/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_RJCSINJ2");
        // get one employee
        from("direct:get-employee_RJCSINJ2")
                .routeId("get-employee-api_RJCSINJ2")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointRJCSINJ2_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_RJCSINJ2")
                .routeId("get-employees-by-firstname-lastname-api_RJCSINJ2")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointRJCSINJ2_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
