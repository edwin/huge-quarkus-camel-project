...
@ApplicationScoped
public class EmployeeQIFMIKPMRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_QIFMIKPM/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_QIFMIKPM")
            .get("/employees_QIFMIKPM/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_QIFMIKPM");
        // get one employee
        from("direct:get-employee_QIFMIKPM")
                .routeId("get-employee-api_QIFMIKPM")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointQIFMIKPM_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_QIFMIKPM")
                .routeId("get-employees-by-firstname-lastname-api_QIFMIKPM")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointQIFMIKPM_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
