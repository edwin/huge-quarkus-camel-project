...
@ApplicationScoped
public class EmployeePJOS2XFFRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_PJOS2XFF/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_PJOS2XFF")
            .get("/employees_PJOS2XFF/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_PJOS2XFF");
        // get one employee
        from("direct:get-employee_PJOS2XFF")
                .routeId("get-employee-api_PJOS2XFF")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointPJOS2XFF_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_PJOS2XFF")
                .routeId("get-employees-by-firstname-lastname-api_PJOS2XFF")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointPJOS2XFF_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
