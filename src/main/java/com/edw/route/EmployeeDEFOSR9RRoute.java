...
@ApplicationScoped
public class EmployeeDEFOSR9RRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_DEFOSR9R/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_DEFOSR9R")
            .get("/employees_DEFOSR9R/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_DEFOSR9R");
        // get one employee
        from("direct:get-employee_DEFOSR9R")
                .routeId("get-employee-api_DEFOSR9R")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointDEFOSR9R_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_DEFOSR9R")
                .routeId("get-employees-by-firstname-lastname-api_DEFOSR9R")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointDEFOSR9R_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
