...
@ApplicationScoped
public class EmployeeNG3D0YL6Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_NG3D0YL6/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_NG3D0YL6")
            .get("/employees_NG3D0YL6/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_NG3D0YL6");
        // get one employee
        from("direct:get-employee_NG3D0YL6")
                .routeId("get-employee-api_NG3D0YL6")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointNG3D0YL6_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_NG3D0YL6")
                .routeId("get-employees-by-firstname-lastname-api_NG3D0YL6")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointNG3D0YL6_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
