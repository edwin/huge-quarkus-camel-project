...
@ApplicationScoped
public class EmployeeIGQFNUJHRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_IGQFNUJH/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_IGQFNUJH")
            .get("/employees_IGQFNUJH/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_IGQFNUJH");
        // get one employee
        from("direct:get-employee_IGQFNUJH")
                .routeId("get-employee-api_IGQFNUJH")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointIGQFNUJH_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_IGQFNUJH")
                .routeId("get-employees-by-firstname-lastname-api_IGQFNUJH")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointIGQFNUJH_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
