...
@ApplicationScoped
public class EmployeeF5ESL19DRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_F5ESL19D/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_F5ESL19D")
            .get("/employees_F5ESL19D/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_F5ESL19D");
        // get one employee
        from("direct:get-employee_F5ESL19D")
                .routeId("get-employee-api_F5ESL19D")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointF5ESL19D_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_F5ESL19D")
                .routeId("get-employees-by-firstname-lastname-api_F5ESL19D")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointF5ESL19D_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
