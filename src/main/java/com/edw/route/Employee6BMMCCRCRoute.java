...
@ApplicationScoped
public class Employee6BMMCCRCRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_6BMMCCRC/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_6BMMCCRC")
            .get("/employees_6BMMCCRC/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_6BMMCCRC");
        // get one employee
        from("direct:get-employee_6BMMCCRC")
                .routeId("get-employee-api_6BMMCCRC")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint6BMMCCRC_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_6BMMCCRC")
                .routeId("get-employees-by-firstname-lastname-api_6BMMCCRC")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint6BMMCCRC_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
