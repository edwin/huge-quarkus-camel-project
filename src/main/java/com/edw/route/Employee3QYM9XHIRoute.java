...
@ApplicationScoped
public class Employee3QYM9XHIRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_3QYM9XHI/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_3QYM9XHI")
            .get("/employees_3QYM9XHI/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_3QYM9XHI");
        // get one employee
        from("direct:get-employee_3QYM9XHI")
                .routeId("get-employee-api_3QYM9XHI")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint3QYM9XHI_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_3QYM9XHI")
                .routeId("get-employees-by-firstname-lastname-api_3QYM9XHI")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint3QYM9XHI_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
