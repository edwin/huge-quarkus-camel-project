...
@ApplicationScoped
public class EmployeeT5KL8MX6Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_T5KL8MX6/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_T5KL8MX6")
            .get("/employees_T5KL8MX6/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_T5KL8MX6");
        // get one employee
        from("direct:get-employee_T5KL8MX6")
                .routeId("get-employee-api_T5KL8MX6")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointT5KL8MX6_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_T5KL8MX6")
                .routeId("get-employees-by-firstname-lastname-api_T5KL8MX6")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointT5KL8MX6_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
