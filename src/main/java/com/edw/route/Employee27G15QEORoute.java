...
@ApplicationScoped
public class Employee27G15QEORoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_27G15QEO/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_27G15QEO")
            .get("/employees_27G15QEO/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_27G15QEO");
        // get one employee
        from("direct:get-employee_27G15QEO")
                .routeId("get-employee-api_27G15QEO")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint27G15QEO_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_27G15QEO")
                .routeId("get-employees-by-firstname-lastname-api_27G15QEO")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint27G15QEO_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
