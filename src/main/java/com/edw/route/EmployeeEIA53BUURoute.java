...
@ApplicationScoped
public class EmployeeEIA53BUURoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_EIA53BUU/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_EIA53BUU")
            .get("/employees_EIA53BUU/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_EIA53BUU");
        // get one employee
        from("direct:get-employee_EIA53BUU")
                .routeId("get-employee-api_EIA53BUU")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointEIA53BUU_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_EIA53BUU")
                .routeId("get-employees-by-firstname-lastname-api_EIA53BUU")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointEIA53BUU_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
