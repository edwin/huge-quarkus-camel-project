...
@ApplicationScoped
public class EmployeeRAG89U5ZRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_RAG89U5Z/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_RAG89U5Z")
            .get("/employees_RAG89U5Z/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_RAG89U5Z");
        // get one employee
        from("direct:get-employee_RAG89U5Z")
                .routeId("get-employee-api_RAG89U5Z")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointRAG89U5Z_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_RAG89U5Z")
                .routeId("get-employees-by-firstname-lastname-api_RAG89U5Z")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointRAG89U5Z_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
