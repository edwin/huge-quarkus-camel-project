...
@ApplicationScoped
public class EmployeeQ11WZKV4Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_Q11WZKV4/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_Q11WZKV4")
            .get("/employees_Q11WZKV4/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_Q11WZKV4");
        // get one employee
        from("direct:get-employee_Q11WZKV4")
                .routeId("get-employee-api_Q11WZKV4")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointQ11WZKV4_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_Q11WZKV4")
                .routeId("get-employees-by-firstname-lastname-api_Q11WZKV4")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointQ11WZKV4_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
