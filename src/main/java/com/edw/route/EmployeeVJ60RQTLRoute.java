...
@ApplicationScoped
public class EmployeeVJ60RQTLRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_VJ60RQTL/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_VJ60RQTL")
            .get("/employees_VJ60RQTL/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_VJ60RQTL");
        // get one employee
        from("direct:get-employee_VJ60RQTL")
                .routeId("get-employee-api_VJ60RQTL")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointVJ60RQTL_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_VJ60RQTL")
                .routeId("get-employees-by-firstname-lastname-api_VJ60RQTL")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointVJ60RQTL_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
