...
@ApplicationScoped
public class EmployeeHBK1AQ6HRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_HBK1AQ6H/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_HBK1AQ6H")
            .get("/employees_HBK1AQ6H/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_HBK1AQ6H");
        // get one employee
        from("direct:get-employee_HBK1AQ6H")
                .routeId("get-employee-api_HBK1AQ6H")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointHBK1AQ6H_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_HBK1AQ6H")
                .routeId("get-employees-by-firstname-lastname-api_HBK1AQ6H")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointHBK1AQ6H_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
