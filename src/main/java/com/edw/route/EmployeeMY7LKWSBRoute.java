...
@ApplicationScoped
public class EmployeeMY7LKWSBRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_MY7LKWSB/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_MY7LKWSB")
            .get("/employees_MY7LKWSB/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_MY7LKWSB");
        // get one employee
        from("direct:get-employee_MY7LKWSB")
                .routeId("get-employee-api_MY7LKWSB")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointMY7LKWSB_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_MY7LKWSB")
                .routeId("get-employees-by-firstname-lastname-api_MY7LKWSB")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointMY7LKWSB_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
