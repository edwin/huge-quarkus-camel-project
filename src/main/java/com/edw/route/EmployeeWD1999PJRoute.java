...
@ApplicationScoped
public class EmployeeWD1999PJRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_WD1999PJ/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_WD1999PJ")
            .get("/employees_WD1999PJ/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_WD1999PJ");
        // get one employee
        from("direct:get-employee_WD1999PJ")
                .routeId("get-employee-api_WD1999PJ")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointWD1999PJ_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_WD1999PJ")
                .routeId("get-employees-by-firstname-lastname-api_WD1999PJ")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointWD1999PJ_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
