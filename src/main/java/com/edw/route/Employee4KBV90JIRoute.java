...
@ApplicationScoped
public class Employee4KBV90JIRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_4KBV90JI/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_4KBV90JI")
            .get("/employees_4KBV90JI/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_4KBV90JI");
        // get one employee
        from("direct:get-employee_4KBV90JI")
                .routeId("get-employee-api_4KBV90JI")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint4KBV90JI_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_4KBV90JI")
                .routeId("get-employees-by-firstname-lastname-api_4KBV90JI")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint4KBV90JI_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
