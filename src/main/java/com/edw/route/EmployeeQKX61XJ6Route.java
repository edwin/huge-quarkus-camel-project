...
@ApplicationScoped
public class EmployeeQKX61XJ6Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_QKX61XJ6/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_QKX61XJ6")
            .get("/employees_QKX61XJ6/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_QKX61XJ6");
        // get one employee
        from("direct:get-employee_QKX61XJ6")
                .routeId("get-employee-api_QKX61XJ6")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointQKX61XJ6_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_QKX61XJ6")
                .routeId("get-employees-by-firstname-lastname-api_QKX61XJ6")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointQKX61XJ6_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
