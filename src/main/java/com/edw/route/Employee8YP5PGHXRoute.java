...
@ApplicationScoped
public class Employee8YP5PGHXRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_8YP5PGHX/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_8YP5PGHX")
            .get("/employees_8YP5PGHX/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_8YP5PGHX");
        // get one employee
        from("direct:get-employee_8YP5PGHX")
                .routeId("get-employee-api_8YP5PGHX")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint8YP5PGHX_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_8YP5PGHX")
                .routeId("get-employees-by-firstname-lastname-api_8YP5PGHX")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint8YP5PGHX_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
