...
@ApplicationScoped
public class EmployeeZLK32U2BRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_ZLK32U2B/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_ZLK32U2B")
            .get("/employees_ZLK32U2B/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_ZLK32U2B");
        // get one employee
        from("direct:get-employee_ZLK32U2B")
                .routeId("get-employee-api_ZLK32U2B")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointZLK32U2B_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_ZLK32U2B")
                .routeId("get-employees-by-firstname-lastname-api_ZLK32U2B")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointZLK32U2B_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
