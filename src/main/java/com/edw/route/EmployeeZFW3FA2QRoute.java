...
@ApplicationScoped
public class EmployeeZFW3FA2QRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_ZFW3FA2Q/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_ZFW3FA2Q")
            .get("/employees_ZFW3FA2Q/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_ZFW3FA2Q");
        // get one employee
        from("direct:get-employee_ZFW3FA2Q")
                .routeId("get-employee-api_ZFW3FA2Q")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointZFW3FA2Q_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_ZFW3FA2Q")
                .routeId("get-employees-by-firstname-lastname-api_ZFW3FA2Q")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointZFW3FA2Q_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
