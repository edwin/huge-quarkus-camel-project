...
@ApplicationScoped
public class EmployeeJUP0HAGIRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_JUP0HAGI/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_JUP0HAGI")
            .get("/employees_JUP0HAGI/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_JUP0HAGI");
        // get one employee
        from("direct:get-employee_JUP0HAGI")
                .routeId("get-employee-api_JUP0HAGI")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointJUP0HAGI_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_JUP0HAGI")
                .routeId("get-employees-by-firstname-lastname-api_JUP0HAGI")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointJUP0HAGI_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
