...
@ApplicationScoped
public class EmployeeC6TAV6DURoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_C6TAV6DU/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_C6TAV6DU")
            .get("/employees_C6TAV6DU/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_C6TAV6DU");
        // get one employee
        from("direct:get-employee_C6TAV6DU")
                .routeId("get-employee-api_C6TAV6DU")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointC6TAV6DU_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_C6TAV6DU")
                .routeId("get-employees-by-firstname-lastname-api_C6TAV6DU")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointC6TAV6DU_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
