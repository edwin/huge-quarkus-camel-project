...
@ApplicationScoped
public class EmployeeEFIPZ685Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_EFIPZ685/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_EFIPZ685")
            .get("/employees_EFIPZ685/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_EFIPZ685");
        // get one employee
        from("direct:get-employee_EFIPZ685")
                .routeId("get-employee-api_EFIPZ685")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointEFIPZ685_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_EFIPZ685")
                .routeId("get-employees-by-firstname-lastname-api_EFIPZ685")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointEFIPZ685_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
