...
@ApplicationScoped
public class Employee9DAC79QQRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_9DAC79QQ/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_9DAC79QQ")
            .get("/employees_9DAC79QQ/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_9DAC79QQ");
        // get one employee
        from("direct:get-employee_9DAC79QQ")
                .routeId("get-employee-api_9DAC79QQ")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint9DAC79QQ_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_9DAC79QQ")
                .routeId("get-employees-by-firstname-lastname-api_9DAC79QQ")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint9DAC79QQ_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
