...
@ApplicationScoped
public class EmployeeM24T5VX9Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_M24T5VX9/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_M24T5VX9")
            .get("/employees_M24T5VX9/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_M24T5VX9");
        // get one employee
        from("direct:get-employee_M24T5VX9")
                .routeId("get-employee-api_M24T5VX9")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointM24T5VX9_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_M24T5VX9")
                .routeId("get-employees-by-firstname-lastname-api_M24T5VX9")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointM24T5VX9_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
