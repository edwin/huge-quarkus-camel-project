...
@ApplicationScoped
public class Employee1L93QHE6Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_1L93QHE6/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_1L93QHE6")
            .get("/employees_1L93QHE6/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_1L93QHE6");
        // get one employee
        from("direct:get-employee_1L93QHE6")
                .routeId("get-employee-api_1L93QHE6")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint1L93QHE6_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_1L93QHE6")
                .routeId("get-employees-by-firstname-lastname-api_1L93QHE6")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint1L93QHE6_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
