...
@ApplicationScoped
public class EmployeeNM2IXFCXRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_NM2IXFCX/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_NM2IXFCX")
            .get("/employees_NM2IXFCX/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_NM2IXFCX");
        // get one employee
        from("direct:get-employee_NM2IXFCX")
                .routeId("get-employee-api_NM2IXFCX")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointNM2IXFCX_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_NM2IXFCX")
                .routeId("get-employees-by-firstname-lastname-api_NM2IXFCX")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointNM2IXFCX_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
