...
@ApplicationScoped
public class EmployeePL05RD1IRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_PL05RD1I/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_PL05RD1I")
            .get("/employees_PL05RD1I/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_PL05RD1I");
        // get one employee
        from("direct:get-employee_PL05RD1I")
                .routeId("get-employee-api_PL05RD1I")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointPL05RD1I_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_PL05RD1I")
                .routeId("get-employees-by-firstname-lastname-api_PL05RD1I")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointPL05RD1I_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
