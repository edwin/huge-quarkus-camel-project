...
@ApplicationScoped
public class EmployeeF6OHPI5TRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_F6OHPI5T/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_F6OHPI5T")
            .get("/employees_F6OHPI5T/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_F6OHPI5T");
        // get one employee
        from("direct:get-employee_F6OHPI5T")
                .routeId("get-employee-api_F6OHPI5T")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointF6OHPI5T_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_F6OHPI5T")
                .routeId("get-employees-by-firstname-lastname-api_F6OHPI5T")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointF6OHPI5T_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
