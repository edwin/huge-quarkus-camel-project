...
@ApplicationScoped
public class EmployeeA25JDPGNRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_A25JDPGN/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_A25JDPGN")
            .get("/employees_A25JDPGN/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_A25JDPGN");
        // get one employee
        from("direct:get-employee_A25JDPGN")
                .routeId("get-employee-api_A25JDPGN")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointA25JDPGN_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_A25JDPGN")
                .routeId("get-employees-by-firstname-lastname-api_A25JDPGN")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointA25JDPGN_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
