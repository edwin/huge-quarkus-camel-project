...
@ApplicationScoped
public class EmployeeDBY14ZMDRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_DBY14ZMD/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_DBY14ZMD")
            .get("/employees_DBY14ZMD/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_DBY14ZMD");
        // get one employee
        from("direct:get-employee_DBY14ZMD")
                .routeId("get-employee-api_DBY14ZMD")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointDBY14ZMD_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_DBY14ZMD")
                .routeId("get-employees-by-firstname-lastname-api_DBY14ZMD")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointDBY14ZMD_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
