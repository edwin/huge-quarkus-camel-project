...
@ApplicationScoped
public class Employee2YKPQ7B2Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_2YKPQ7B2/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_2YKPQ7B2")
            .get("/employees_2YKPQ7B2/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_2YKPQ7B2");
        // get one employee
        from("direct:get-employee_2YKPQ7B2")
                .routeId("get-employee-api_2YKPQ7B2")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint2YKPQ7B2_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_2YKPQ7B2")
                .routeId("get-employees-by-firstname-lastname-api_2YKPQ7B2")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint2YKPQ7B2_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
