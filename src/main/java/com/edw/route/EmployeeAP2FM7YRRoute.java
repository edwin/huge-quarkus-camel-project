...
@ApplicationScoped
public class EmployeeAP2FM7YRRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_AP2FM7YR/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_AP2FM7YR")
            .get("/employees_AP2FM7YR/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_AP2FM7YR");
        // get one employee
        from("direct:get-employee_AP2FM7YR")
                .routeId("get-employee-api_AP2FM7YR")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointAP2FM7YR_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_AP2FM7YR")
                .routeId("get-employees-by-firstname-lastname-api_AP2FM7YR")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointAP2FM7YR_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
