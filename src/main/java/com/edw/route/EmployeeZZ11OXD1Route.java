...
@ApplicationScoped
public class EmployeeZZ11OXD1Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_ZZ11OXD1/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_ZZ11OXD1")
            .get("/employees_ZZ11OXD1/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_ZZ11OXD1");
        // get one employee
        from("direct:get-employee_ZZ11OXD1")
                .routeId("get-employee-api_ZZ11OXD1")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointZZ11OXD1_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_ZZ11OXD1")
                .routeId("get-employees-by-firstname-lastname-api_ZZ11OXD1")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointZZ11OXD1_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
