...
@ApplicationScoped
public class EmployeeVN4R9GIDRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_VN4R9GID/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_VN4R9GID")
            .get("/employees_VN4R9GID/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_VN4R9GID");
        // get one employee
        from("direct:get-employee_VN4R9GID")
                .routeId("get-employee-api_VN4R9GID")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointVN4R9GID_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_VN4R9GID")
                .routeId("get-employees-by-firstname-lastname-api_VN4R9GID")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointVN4R9GID_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
