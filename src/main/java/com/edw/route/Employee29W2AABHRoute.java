...
@ApplicationScoped
public class Employee29W2AABHRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_29W2AABH/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_29W2AABH")
            .get("/employees_29W2AABH/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_29W2AABH");
        // get one employee
        from("direct:get-employee_29W2AABH")
                .routeId("get-employee-api_29W2AABH")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint29W2AABH_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_29W2AABH")
                .routeId("get-employees-by-firstname-lastname-api_29W2AABH")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint29W2AABH_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
