...
@ApplicationScoped
public class EmployeeV12DCVHRRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_V12DCVHR/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_V12DCVHR")
            .get("/employees_V12DCVHR/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_V12DCVHR");
        // get one employee
        from("direct:get-employee_V12DCVHR")
                .routeId("get-employee-api_V12DCVHR")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointV12DCVHR_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_V12DCVHR")
                .routeId("get-employees-by-firstname-lastname-api_V12DCVHR")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointV12DCVHR_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
