...
@ApplicationScoped
public class EmployeeOMS21REPRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_OMS21REP/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_OMS21REP")
            .get("/employees_OMS21REP/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_OMS21REP");
        // get one employee
        from("direct:get-employee_OMS21REP")
                .routeId("get-employee-api_OMS21REP")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointOMS21REP_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_OMS21REP")
                .routeId("get-employees-by-firstname-lastname-api_OMS21REP")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointOMS21REP_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
