...
@ApplicationScoped
public class EmployeeFB0MX35JRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_FB0MX35J/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_FB0MX35J")
            .get("/employees_FB0MX35J/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_FB0MX35J");
        // get one employee
        from("direct:get-employee_FB0MX35J")
                .routeId("get-employee-api_FB0MX35J")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointFB0MX35J_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_FB0MX35J")
                .routeId("get-employees-by-firstname-lastname-api_FB0MX35J")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointFB0MX35J_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
