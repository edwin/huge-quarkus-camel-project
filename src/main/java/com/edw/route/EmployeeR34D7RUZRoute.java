...
@ApplicationScoped
public class EmployeeR34D7RUZRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_R34D7RUZ/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_R34D7RUZ")
            .get("/employees_R34D7RUZ/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_R34D7RUZ");
        // get one employee
        from("direct:get-employee_R34D7RUZ")
                .routeId("get-employee-api_R34D7RUZ")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointR34D7RUZ_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_R34D7RUZ")
                .routeId("get-employees-by-firstname-lastname-api_R34D7RUZ")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointR34D7RUZ_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
