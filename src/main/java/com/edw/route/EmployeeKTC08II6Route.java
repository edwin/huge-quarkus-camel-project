...
@ApplicationScoped
public class EmployeeKTC08II6Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_KTC08II6/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_KTC08II6")
            .get("/employees_KTC08II6/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_KTC08II6");
        // get one employee
        from("direct:get-employee_KTC08II6")
                .routeId("get-employee-api_KTC08II6")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointKTC08II6_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_KTC08II6")
                .routeId("get-employees-by-firstname-lastname-api_KTC08II6")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointKTC08II6_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
