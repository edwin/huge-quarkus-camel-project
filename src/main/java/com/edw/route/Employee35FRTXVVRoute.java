...
@ApplicationScoped
public class Employee35FRTXVVRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_35FRTXVV/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_35FRTXVV")
            .get("/employees_35FRTXVV/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_35FRTXVV");
        // get one employee
        from("direct:get-employee_35FRTXVV")
                .routeId("get-employee-api_35FRTXVV")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint35FRTXVV_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_35FRTXVV")
                .routeId("get-employees-by-firstname-lastname-api_35FRTXVV")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint35FRTXVV_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
