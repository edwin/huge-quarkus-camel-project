...
@ApplicationScoped
public class EmployeeUMY7ILNDRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_UMY7ILND/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_UMY7ILND")
            .get("/employees_UMY7ILND/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_UMY7ILND");
        // get one employee
        from("direct:get-employee_UMY7ILND")
                .routeId("get-employee-api_UMY7ILND")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointUMY7ILND_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_UMY7ILND")
                .routeId("get-employees-by-firstname-lastname-api_UMY7ILND")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointUMY7ILND_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
