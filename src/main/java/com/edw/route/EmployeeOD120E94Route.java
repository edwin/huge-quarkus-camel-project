...
@ApplicationScoped
public class EmployeeOD120E94Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_OD120E94/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_OD120E94")
            .get("/employees_OD120E94/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_OD120E94");
        // get one employee
        from("direct:get-employee_OD120E94")
                .routeId("get-employee-api_OD120E94")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointOD120E94_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_OD120E94")
                .routeId("get-employees-by-firstname-lastname-api_OD120E94")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointOD120E94_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
