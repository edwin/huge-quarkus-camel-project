...
@ApplicationScoped
public class EmployeeF2TN79KDRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_F2TN79KD/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_F2TN79KD")
            .get("/employees_F2TN79KD/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_F2TN79KD");
        // get one employee
        from("direct:get-employee_F2TN79KD")
                .routeId("get-employee-api_F2TN79KD")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointF2TN79KD_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_F2TN79KD")
                .routeId("get-employees-by-firstname-lastname-api_F2TN79KD")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointF2TN79KD_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
