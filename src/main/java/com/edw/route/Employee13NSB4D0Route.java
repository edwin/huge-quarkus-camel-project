...
@ApplicationScoped
public class Employee13NSB4D0Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_13NSB4D0/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_13NSB4D0")
            .get("/employees_13NSB4D0/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_13NSB4D0");
        // get one employee
        from("direct:get-employee_13NSB4D0")
                .routeId("get-employee-api_13NSB4D0")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint13NSB4D0_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_13NSB4D0")
                .routeId("get-employees-by-firstname-lastname-api_13NSB4D0")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint13NSB4D0_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
