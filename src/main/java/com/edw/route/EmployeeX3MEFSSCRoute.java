...
@ApplicationScoped
public class EmployeeX3MEFSSCRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_X3MEFSSC/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_X3MEFSSC")
            .get("/employees_X3MEFSSC/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_X3MEFSSC");
        // get one employee
        from("direct:get-employee_X3MEFSSC")
                .routeId("get-employee-api_X3MEFSSC")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointX3MEFSSC_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_X3MEFSSC")
                .routeId("get-employees-by-firstname-lastname-api_X3MEFSSC")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointX3MEFSSC_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
