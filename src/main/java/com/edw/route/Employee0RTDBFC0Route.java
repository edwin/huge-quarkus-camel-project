...
@ApplicationScoped
public class Employee0RTDBFC0Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_0RTDBFC0/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_0RTDBFC0")
            .get("/employees_0RTDBFC0/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_0RTDBFC0");
        // get one employee
        from("direct:get-employee_0RTDBFC0")
                .routeId("get-employee-api_0RTDBFC0")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint0RTDBFC0_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_0RTDBFC0")
                .routeId("get-employees-by-firstname-lastname-api_0RTDBFC0")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint0RTDBFC0_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
