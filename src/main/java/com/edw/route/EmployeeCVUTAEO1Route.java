...
@ApplicationScoped
public class EmployeeCVUTAEO1Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_CVUTAEO1/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_CVUTAEO1")
            .get("/employees_CVUTAEO1/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_CVUTAEO1");
        // get one employee
        from("direct:get-employee_CVUTAEO1")
                .routeId("get-employee-api_CVUTAEO1")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointCVUTAEO1_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_CVUTAEO1")
                .routeId("get-employees-by-firstname-lastname-api_CVUTAEO1")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointCVUTAEO1_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
