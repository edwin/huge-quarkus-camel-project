...
@ApplicationScoped
public class EmployeeYSUKUXTTRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_YSUKUXTT/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_YSUKUXTT")
            .get("/employees_YSUKUXTT/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_YSUKUXTT");
        // get one employee
        from("direct:get-employee_YSUKUXTT")
                .routeId("get-employee-api_YSUKUXTT")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointYSUKUXTT_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_YSUKUXTT")
                .routeId("get-employees-by-firstname-lastname-api_YSUKUXTT")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointYSUKUXTT_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
