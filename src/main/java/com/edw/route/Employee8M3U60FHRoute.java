...
@ApplicationScoped
public class Employee8M3U60FHRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_8M3U60FH/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_8M3U60FH")
            .get("/employees_8M3U60FH/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_8M3U60FH");
        // get one employee
        from("direct:get-employee_8M3U60FH")
                .routeId("get-employee-api_8M3U60FH")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint8M3U60FH_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_8M3U60FH")
                .routeId("get-employees-by-firstname-lastname-api_8M3U60FH")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint8M3U60FH_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
