...
@ApplicationScoped
public class Employee9XDQ0GXYRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_9XDQ0GXY/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_9XDQ0GXY")
            .get("/employees_9XDQ0GXY/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_9XDQ0GXY");
        // get one employee
        from("direct:get-employee_9XDQ0GXY")
                .routeId("get-employee-api_9XDQ0GXY")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint9XDQ0GXY_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_9XDQ0GXY")
                .routeId("get-employees-by-firstname-lastname-api_9XDQ0GXY")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint9XDQ0GXY_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
