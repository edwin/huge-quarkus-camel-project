...
@ApplicationScoped
public class EmployeeN8U9KM6HRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_N8U9KM6H/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_N8U9KM6H")
            .get("/employees_N8U9KM6H/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_N8U9KM6H");
        // get one employee
        from("direct:get-employee_N8U9KM6H")
                .routeId("get-employee-api_N8U9KM6H")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointN8U9KM6H_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_N8U9KM6H")
                .routeId("get-employees-by-firstname-lastname-api_N8U9KM6H")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointN8U9KM6H_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
