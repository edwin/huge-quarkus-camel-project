...
@ApplicationScoped
public class EmployeeXJ4OPFYYRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_XJ4OPFYY/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_XJ4OPFYY")
            .get("/employees_XJ4OPFYY/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_XJ4OPFYY");
        // get one employee
        from("direct:get-employee_XJ4OPFYY")
                .routeId("get-employee-api_XJ4OPFYY")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointXJ4OPFYY_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_XJ4OPFYY")
                .routeId("get-employees-by-firstname-lastname-api_XJ4OPFYY")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointXJ4OPFYY_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
