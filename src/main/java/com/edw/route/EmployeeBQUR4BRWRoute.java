...
@ApplicationScoped
public class EmployeeBQUR4BRWRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_BQUR4BRW/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_BQUR4BRW")
            .get("/employees_BQUR4BRW/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_BQUR4BRW");
        // get one employee
        from("direct:get-employee_BQUR4BRW")
                .routeId("get-employee-api_BQUR4BRW")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointBQUR4BRW_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_BQUR4BRW")
                .routeId("get-employees-by-firstname-lastname-api_BQUR4BRW")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointBQUR4BRW_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
