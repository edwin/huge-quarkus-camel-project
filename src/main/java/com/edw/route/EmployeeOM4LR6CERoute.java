...
@ApplicationScoped
public class EmployeeOM4LR6CERoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_OM4LR6CE/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_OM4LR6CE")
            .get("/employees_OM4LR6CE/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_OM4LR6CE");
        // get one employee
        from("direct:get-employee_OM4LR6CE")
                .routeId("get-employee-api_OM4LR6CE")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointOM4LR6CE_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_OM4LR6CE")
                .routeId("get-employees-by-firstname-lastname-api_OM4LR6CE")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointOM4LR6CE_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
