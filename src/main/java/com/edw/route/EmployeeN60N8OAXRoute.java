...
@ApplicationScoped
public class EmployeeN60N8OAXRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_N60N8OAX/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_N60N8OAX")
            .get("/employees_N60N8OAX/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_N60N8OAX");
        // get one employee
        from("direct:get-employee_N60N8OAX")
                .routeId("get-employee-api_N60N8OAX")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointN60N8OAX_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_N60N8OAX")
                .routeId("get-employees-by-firstname-lastname-api_N60N8OAX")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointN60N8OAX_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
