...
@ApplicationScoped
public class EmployeeYPK34ILXRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_YPK34ILX/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_YPK34ILX")
            .get("/employees_YPK34ILX/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_YPK34ILX");
        // get one employee
        from("direct:get-employee_YPK34ILX")
                .routeId("get-employee-api_YPK34ILX")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointYPK34ILX_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_YPK34ILX")
                .routeId("get-employees-by-firstname-lastname-api_YPK34ILX")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointYPK34ILX_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
