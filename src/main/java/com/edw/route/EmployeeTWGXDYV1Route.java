...
@ApplicationScoped
public class EmployeeTWGXDYV1Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_TWGXDYV1/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_TWGXDYV1")
            .get("/employees_TWGXDYV1/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_TWGXDYV1");
        // get one employee
        from("direct:get-employee_TWGXDYV1")
                .routeId("get-employee-api_TWGXDYV1")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointTWGXDYV1_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_TWGXDYV1")
                .routeId("get-employees-by-firstname-lastname-api_TWGXDYV1")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointTWGXDYV1_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
