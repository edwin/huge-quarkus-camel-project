...
@ApplicationScoped
public class EmployeeBJKFONKARoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_BJKFONKA/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_BJKFONKA")
            .get("/employees_BJKFONKA/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_BJKFONKA");
        // get one employee
        from("direct:get-employee_BJKFONKA")
                .routeId("get-employee-api_BJKFONKA")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointBJKFONKA_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_BJKFONKA")
                .routeId("get-employees-by-firstname-lastname-api_BJKFONKA")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointBJKFONKA_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
