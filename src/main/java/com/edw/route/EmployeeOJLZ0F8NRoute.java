...
@ApplicationScoped
public class EmployeeOJLZ0F8NRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_OJLZ0F8N/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_OJLZ0F8N")
            .get("/employees_OJLZ0F8N/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_OJLZ0F8N");
        // get one employee
        from("direct:get-employee_OJLZ0F8N")
                .routeId("get-employee-api_OJLZ0F8N")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointOJLZ0F8N_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_OJLZ0F8N")
                .routeId("get-employees-by-firstname-lastname-api_OJLZ0F8N")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointOJLZ0F8N_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
