...
@ApplicationScoped
public class EmployeePVFY7V2HRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_PVFY7V2H/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_PVFY7V2H")
            .get("/employees_PVFY7V2H/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_PVFY7V2H");
        // get one employee
        from("direct:get-employee_PVFY7V2H")
                .routeId("get-employee-api_PVFY7V2H")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointPVFY7V2H_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_PVFY7V2H")
                .routeId("get-employees-by-firstname-lastname-api_PVFY7V2H")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointPVFY7V2H_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
