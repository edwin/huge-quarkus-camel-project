...
@ApplicationScoped
public class EmployeeDWAZ7AD8Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_DWAZ7AD8/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_DWAZ7AD8")
            .get("/employees_DWAZ7AD8/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_DWAZ7AD8");
        // get one employee
        from("direct:get-employee_DWAZ7AD8")
                .routeId("get-employee-api_DWAZ7AD8")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointDWAZ7AD8_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_DWAZ7AD8")
                .routeId("get-employees-by-firstname-lastname-api_DWAZ7AD8")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointDWAZ7AD8_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
