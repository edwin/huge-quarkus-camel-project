...
@ApplicationScoped
public class EmployeeFSTCSRZ9Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_FSTCSRZ9/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_FSTCSRZ9")
            .get("/employees_FSTCSRZ9/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_FSTCSRZ9");
        // get one employee
        from("direct:get-employee_FSTCSRZ9")
                .routeId("get-employee-api_FSTCSRZ9")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointFSTCSRZ9_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_FSTCSRZ9")
                .routeId("get-employees-by-firstname-lastname-api_FSTCSRZ9")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointFSTCSRZ9_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
