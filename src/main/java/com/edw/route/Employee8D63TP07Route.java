...
@ApplicationScoped
public class Employee8D63TP07Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_8D63TP07/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_8D63TP07")
            .get("/employees_8D63TP07/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_8D63TP07");
        // get one employee
        from("direct:get-employee_8D63TP07")
                .routeId("get-employee-api_8D63TP07")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint8D63TP07_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_8D63TP07")
                .routeId("get-employees-by-firstname-lastname-api_8D63TP07")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint8D63TP07_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
