...
@ApplicationScoped
public class EmployeeQFEBJI1YRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_QFEBJI1Y/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_QFEBJI1Y")
            .get("/employees_QFEBJI1Y/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_QFEBJI1Y");
        // get one employee
        from("direct:get-employee_QFEBJI1Y")
                .routeId("get-employee-api_QFEBJI1Y")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointQFEBJI1Y_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_QFEBJI1Y")
                .routeId("get-employees-by-firstname-lastname-api_QFEBJI1Y")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointQFEBJI1Y_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
