...
@ApplicationScoped
public class EmployeeKS2HP07LRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_KS2HP07L/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_KS2HP07L")
            .get("/employees_KS2HP07L/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_KS2HP07L");
        // get one employee
        from("direct:get-employee_KS2HP07L")
                .routeId("get-employee-api_KS2HP07L")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointKS2HP07L_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_KS2HP07L")
                .routeId("get-employees-by-firstname-lastname-api_KS2HP07L")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointKS2HP07L_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
