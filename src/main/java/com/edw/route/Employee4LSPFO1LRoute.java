...
@ApplicationScoped
public class Employee4LSPFO1LRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_4LSPFO1L/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_4LSPFO1L")
            .get("/employees_4LSPFO1L/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_4LSPFO1L");
        // get one employee
        from("direct:get-employee_4LSPFO1L")
                .routeId("get-employee-api_4LSPFO1L")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint4LSPFO1L_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_4LSPFO1L")
                .routeId("get-employees-by-firstname-lastname-api_4LSPFO1L")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint4LSPFO1L_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
