...
@ApplicationScoped
public class EmployeeA370BWC0Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_A370BWC0/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_A370BWC0")
            .get("/employees_A370BWC0/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_A370BWC0");
        // get one employee
        from("direct:get-employee_A370BWC0")
                .routeId("get-employee-api_A370BWC0")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointA370BWC0_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_A370BWC0")
                .routeId("get-employees-by-firstname-lastname-api_A370BWC0")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointA370BWC0_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
