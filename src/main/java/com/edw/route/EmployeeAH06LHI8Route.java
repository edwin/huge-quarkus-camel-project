...
@ApplicationScoped
public class EmployeeAH06LHI8Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_AH06LHI8/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_AH06LHI8")
            .get("/employees_AH06LHI8/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_AH06LHI8");
        // get one employee
        from("direct:get-employee_AH06LHI8")
                .routeId("get-employee-api_AH06LHI8")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointAH06LHI8_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_AH06LHI8")
                .routeId("get-employees-by-firstname-lastname-api_AH06LHI8")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointAH06LHI8_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
