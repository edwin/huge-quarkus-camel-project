...
@ApplicationScoped
public class Employee8NWYX1JFRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_8NWYX1JF/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_8NWYX1JF")
            .get("/employees_8NWYX1JF/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_8NWYX1JF");
        // get one employee
        from("direct:get-employee_8NWYX1JF")
                .routeId("get-employee-api_8NWYX1JF")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint8NWYX1JF_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_8NWYX1JF")
                .routeId("get-employees-by-firstname-lastname-api_8NWYX1JF")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint8NWYX1JF_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
