...
@ApplicationScoped
public class Employee95SIE4NWRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_95SIE4NW/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_95SIE4NW")
            .get("/employees_95SIE4NW/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_95SIE4NW");
        // get one employee
        from("direct:get-employee_95SIE4NW")
                .routeId("get-employee-api_95SIE4NW")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint95SIE4NW_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_95SIE4NW")
                .routeId("get-employees-by-firstname-lastname-api_95SIE4NW")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint95SIE4NW_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
