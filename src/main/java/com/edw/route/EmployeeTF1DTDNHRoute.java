...
@ApplicationScoped
public class EmployeeTF1DTDNHRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_TF1DTDNH/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_TF1DTDNH")
            .get("/employees_TF1DTDNH/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_TF1DTDNH");
        // get one employee
        from("direct:get-employee_TF1DTDNH")
                .routeId("get-employee-api_TF1DTDNH")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointTF1DTDNH_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_TF1DTDNH")
                .routeId("get-employees-by-firstname-lastname-api_TF1DTDNH")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointTF1DTDNH_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
