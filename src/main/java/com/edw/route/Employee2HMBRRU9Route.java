...
@ApplicationScoped
public class Employee2HMBRRU9Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_2HMBRRU9/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_2HMBRRU9")
            .get("/employees_2HMBRRU9/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_2HMBRRU9");
        // get one employee
        from("direct:get-employee_2HMBRRU9")
                .routeId("get-employee-api_2HMBRRU9")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint2HMBRRU9_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_2HMBRRU9")
                .routeId("get-employees-by-firstname-lastname-api_2HMBRRU9")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint2HMBRRU9_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
