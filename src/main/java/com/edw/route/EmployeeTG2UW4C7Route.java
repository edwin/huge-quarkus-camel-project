...
@ApplicationScoped
public class EmployeeTG2UW4C7Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_TG2UW4C7/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_TG2UW4C7")
            .get("/employees_TG2UW4C7/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_TG2UW4C7");
        // get one employee
        from("direct:get-employee_TG2UW4C7")
                .routeId("get-employee-api_TG2UW4C7")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointTG2UW4C7_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_TG2UW4C7")
                .routeId("get-employees-by-firstname-lastname-api_TG2UW4C7")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointTG2UW4C7_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
