...
@ApplicationScoped
public class EmployeeY4BG4X70Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_Y4BG4X70/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_Y4BG4X70")
            .get("/employees_Y4BG4X70/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_Y4BG4X70");
        // get one employee
        from("direct:get-employee_Y4BG4X70")
                .routeId("get-employee-api_Y4BG4X70")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointY4BG4X70_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_Y4BG4X70")
                .routeId("get-employees-by-firstname-lastname-api_Y4BG4X70")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointY4BG4X70_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
