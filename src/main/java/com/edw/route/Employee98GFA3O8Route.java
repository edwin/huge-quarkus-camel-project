...
@ApplicationScoped
public class Employee98GFA3O8Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_98GFA3O8/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_98GFA3O8")
            .get("/employees_98GFA3O8/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_98GFA3O8");
        // get one employee
        from("direct:get-employee_98GFA3O8")
                .routeId("get-employee-api_98GFA3O8")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint98GFA3O8_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_98GFA3O8")
                .routeId("get-employees-by-firstname-lastname-api_98GFA3O8")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint98GFA3O8_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
