...
@ApplicationScoped
public class EmployeeEP60I270Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_EP60I270/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_EP60I270")
            .get("/employees_EP60I270/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_EP60I270");
        // get one employee
        from("direct:get-employee_EP60I270")
                .routeId("get-employee-api_EP60I270")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointEP60I270_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_EP60I270")
                .routeId("get-employees-by-firstname-lastname-api_EP60I270")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointEP60I270_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
