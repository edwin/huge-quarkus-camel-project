...
@ApplicationScoped
public class EmployeeXCTLETU2Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_XCTLETU2/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_XCTLETU2")
            .get("/employees_XCTLETU2/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_XCTLETU2");
        // get one employee
        from("direct:get-employee_XCTLETU2")
                .routeId("get-employee-api_XCTLETU2")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointXCTLETU2_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_XCTLETU2")
                .routeId("get-employees-by-firstname-lastname-api_XCTLETU2")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointXCTLETU2_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
