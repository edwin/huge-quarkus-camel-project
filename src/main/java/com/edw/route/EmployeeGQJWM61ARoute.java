...
@ApplicationScoped
public class EmployeeGQJWM61ARoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_GQJWM61A/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_GQJWM61A")
            .get("/employees_GQJWM61A/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_GQJWM61A");
        // get one employee
        from("direct:get-employee_GQJWM61A")
                .routeId("get-employee-api_GQJWM61A")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointGQJWM61A_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_GQJWM61A")
                .routeId("get-employees-by-firstname-lastname-api_GQJWM61A")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointGQJWM61A_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
