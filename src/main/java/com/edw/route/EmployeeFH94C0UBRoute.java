...
@ApplicationScoped
public class EmployeeFH94C0UBRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_FH94C0UB/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_FH94C0UB")
            .get("/employees_FH94C0UB/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_FH94C0UB");
        // get one employee
        from("direct:get-employee_FH94C0UB")
                .routeId("get-employee-api_FH94C0UB")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointFH94C0UB_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_FH94C0UB")
                .routeId("get-employees-by-firstname-lastname-api_FH94C0UB")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointFH94C0UB_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
