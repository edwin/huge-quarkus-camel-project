...
@ApplicationScoped
public class EmployeeITOTYY05Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_ITOTYY05/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_ITOTYY05")
            .get("/employees_ITOTYY05/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_ITOTYY05");
        // get one employee
        from("direct:get-employee_ITOTYY05")
                .routeId("get-employee-api_ITOTYY05")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointITOTYY05_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_ITOTYY05")
                .routeId("get-employees-by-firstname-lastname-api_ITOTYY05")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointITOTYY05_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
