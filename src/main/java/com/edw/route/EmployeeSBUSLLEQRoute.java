...
@ApplicationScoped
public class EmployeeSBUSLLEQRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_SBUSLLEQ/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_SBUSLLEQ")
            .get("/employees_SBUSLLEQ/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_SBUSLLEQ");
        // get one employee
        from("direct:get-employee_SBUSLLEQ")
                .routeId("get-employee-api_SBUSLLEQ")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointSBUSLLEQ_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_SBUSLLEQ")
                .routeId("get-employees-by-firstname-lastname-api_SBUSLLEQ")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointSBUSLLEQ_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
