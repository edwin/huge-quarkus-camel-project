...
@ApplicationScoped
public class EmployeeE10IKG3QRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_E10IKG3Q/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_E10IKG3Q")
            .get("/employees_E10IKG3Q/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_E10IKG3Q");
        // get one employee
        from("direct:get-employee_E10IKG3Q")
                .routeId("get-employee-api_E10IKG3Q")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointE10IKG3Q_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_E10IKG3Q")
                .routeId("get-employees-by-firstname-lastname-api_E10IKG3Q")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointE10IKG3Q_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
