...
@ApplicationScoped
public class EmployeeBZY7SBORRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_BZY7SBOR/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_BZY7SBOR")
            .get("/employees_BZY7SBOR/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_BZY7SBOR");
        // get one employee
        from("direct:get-employee_BZY7SBOR")
                .routeId("get-employee-api_BZY7SBOR")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointBZY7SBOR_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_BZY7SBOR")
                .routeId("get-employees-by-firstname-lastname-api_BZY7SBOR")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointBZY7SBOR_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
