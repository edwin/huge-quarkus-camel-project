...
@ApplicationScoped
public class EmployeeMG7RUB3PRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_MG7RUB3P/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_MG7RUB3P")
            .get("/employees_MG7RUB3P/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_MG7RUB3P");
        // get one employee
        from("direct:get-employee_MG7RUB3P")
                .routeId("get-employee-api_MG7RUB3P")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointMG7RUB3P_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_MG7RUB3P")
                .routeId("get-employees-by-firstname-lastname-api_MG7RUB3P")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointMG7RUB3P_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
