...
@ApplicationScoped
public class EmployeeBX59SDHFRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_BX59SDHF/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_BX59SDHF")
            .get("/employees_BX59SDHF/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_BX59SDHF");
        // get one employee
        from("direct:get-employee_BX59SDHF")
                .routeId("get-employee-api_BX59SDHF")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointBX59SDHF_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_BX59SDHF")
                .routeId("get-employees-by-firstname-lastname-api_BX59SDHF")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointBX59SDHF_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
