...
@ApplicationScoped
public class EmployeeON7SABU5Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_ON7SABU5/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_ON7SABU5")
            .get("/employees_ON7SABU5/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_ON7SABU5");
        // get one employee
        from("direct:get-employee_ON7SABU5")
                .routeId("get-employee-api_ON7SABU5")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointON7SABU5_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_ON7SABU5")
                .routeId("get-employees-by-firstname-lastname-api_ON7SABU5")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointON7SABU5_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
