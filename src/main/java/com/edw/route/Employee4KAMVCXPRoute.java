...
@ApplicationScoped
public class Employee4KAMVCXPRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_4KAMVCXP/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_4KAMVCXP")
            .get("/employees_4KAMVCXP/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_4KAMVCXP");
        // get one employee
        from("direct:get-employee_4KAMVCXP")
                .routeId("get-employee-api_4KAMVCXP")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint4KAMVCXP_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_4KAMVCXP")
                .routeId("get-employees-by-firstname-lastname-api_4KAMVCXP")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint4KAMVCXP_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
