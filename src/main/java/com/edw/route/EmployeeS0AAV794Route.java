...
@ApplicationScoped
public class EmployeeS0AAV794Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_S0AAV794/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_S0AAV794")
            .get("/employees_S0AAV794/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_S0AAV794");
        // get one employee
        from("direct:get-employee_S0AAV794")
                .routeId("get-employee-api_S0AAV794")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointS0AAV794_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_S0AAV794")
                .routeId("get-employees-by-firstname-lastname-api_S0AAV794")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointS0AAV794_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
