...
@ApplicationScoped
public class EmployeeWG9RSML6Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_WG9RSML6/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_WG9RSML6")
            .get("/employees_WG9RSML6/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_WG9RSML6");
        // get one employee
        from("direct:get-employee_WG9RSML6")
                .routeId("get-employee-api_WG9RSML6")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointWG9RSML6_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_WG9RSML6")
                .routeId("get-employees-by-firstname-lastname-api_WG9RSML6")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointWG9RSML6_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
