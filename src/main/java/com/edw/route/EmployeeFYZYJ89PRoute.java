...
@ApplicationScoped
public class EmployeeFYZYJ89PRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_FYZYJ89P/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_FYZYJ89P")
            .get("/employees_FYZYJ89P/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_FYZYJ89P");
        // get one employee
        from("direct:get-employee_FYZYJ89P")
                .routeId("get-employee-api_FYZYJ89P")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointFYZYJ89P_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_FYZYJ89P")
                .routeId("get-employees-by-firstname-lastname-api_FYZYJ89P")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointFYZYJ89P_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
