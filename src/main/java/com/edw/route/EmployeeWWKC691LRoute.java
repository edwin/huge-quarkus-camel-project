...
@ApplicationScoped
public class EmployeeWWKC691LRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_WWKC691L/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_WWKC691L")
            .get("/employees_WWKC691L/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_WWKC691L");
        // get one employee
        from("direct:get-employee_WWKC691L")
                .routeId("get-employee-api_WWKC691L")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointWWKC691L_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_WWKC691L")
                .routeId("get-employees-by-firstname-lastname-api_WWKC691L")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointWWKC691L_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
