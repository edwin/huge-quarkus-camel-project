...
@ApplicationScoped
public class EmployeeSQABJNX2Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_SQABJNX2/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_SQABJNX2")
            .get("/employees_SQABJNX2/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_SQABJNX2");
        // get one employee
        from("direct:get-employee_SQABJNX2")
                .routeId("get-employee-api_SQABJNX2")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointSQABJNX2_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_SQABJNX2")
                .routeId("get-employees-by-firstname-lastname-api_SQABJNX2")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointSQABJNX2_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
