...
@ApplicationScoped
public class EmployeeFTO61Q6KRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_FTO61Q6K/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_FTO61Q6K")
            .get("/employees_FTO61Q6K/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_FTO61Q6K");
        // get one employee
        from("direct:get-employee_FTO61Q6K")
                .routeId("get-employee-api_FTO61Q6K")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointFTO61Q6K_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_FTO61Q6K")
                .routeId("get-employees-by-firstname-lastname-api_FTO61Q6K")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointFTO61Q6K_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
