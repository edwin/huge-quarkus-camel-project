...
@ApplicationScoped
public class EmployeeBSP3JMCNRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_BSP3JMCN/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_BSP3JMCN")
            .get("/employees_BSP3JMCN/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_BSP3JMCN");
        // get one employee
        from("direct:get-employee_BSP3JMCN")
                .routeId("get-employee-api_BSP3JMCN")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointBSP3JMCN_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_BSP3JMCN")
                .routeId("get-employees-by-firstname-lastname-api_BSP3JMCN")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointBSP3JMCN_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
