...
@ApplicationScoped
public class EmployeeY9Y1GU3PRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_Y9Y1GU3P/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_Y9Y1GU3P")
            .get("/employees_Y9Y1GU3P/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_Y9Y1GU3P");
        // get one employee
        from("direct:get-employee_Y9Y1GU3P")
                .routeId("get-employee-api_Y9Y1GU3P")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointY9Y1GU3P_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_Y9Y1GU3P")
                .routeId("get-employees-by-firstname-lastname-api_Y9Y1GU3P")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointY9Y1GU3P_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
