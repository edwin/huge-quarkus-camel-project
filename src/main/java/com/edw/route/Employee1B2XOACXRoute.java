...
@ApplicationScoped
public class Employee1B2XOACXRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_1B2XOACX/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_1B2XOACX")
            .get("/employees_1B2XOACX/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_1B2XOACX");
        // get one employee
        from("direct:get-employee_1B2XOACX")
                .routeId("get-employee-api_1B2XOACX")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint1B2XOACX_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_1B2XOACX")
                .routeId("get-employees-by-firstname-lastname-api_1B2XOACX")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint1B2XOACX_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
