...
@ApplicationScoped
public class EmployeeHANU913PRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_HANU913P/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_HANU913P")
            .get("/employees_HANU913P/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_HANU913P");
        // get one employee
        from("direct:get-employee_HANU913P")
                .routeId("get-employee-api_HANU913P")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointHANU913P_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_HANU913P")
                .routeId("get-employees-by-firstname-lastname-api_HANU913P")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointHANU913P_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
