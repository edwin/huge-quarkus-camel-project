...
@ApplicationScoped
public class EmployeeIKO6SO58Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_IKO6SO58/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_IKO6SO58")
            .get("/employees_IKO6SO58/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_IKO6SO58");
        // get one employee
        from("direct:get-employee_IKO6SO58")
                .routeId("get-employee-api_IKO6SO58")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointIKO6SO58_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_IKO6SO58")
                .routeId("get-employees-by-firstname-lastname-api_IKO6SO58")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointIKO6SO58_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
