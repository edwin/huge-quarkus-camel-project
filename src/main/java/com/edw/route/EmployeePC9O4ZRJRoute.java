...
@ApplicationScoped
public class EmployeePC9O4ZRJRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_PC9O4ZRJ/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_PC9O4ZRJ")
            .get("/employees_PC9O4ZRJ/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_PC9O4ZRJ");
        // get one employee
        from("direct:get-employee_PC9O4ZRJ")
                .routeId("get-employee-api_PC9O4ZRJ")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointPC9O4ZRJ_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_PC9O4ZRJ")
                .routeId("get-employees-by-firstname-lastname-api_PC9O4ZRJ")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointPC9O4ZRJ_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
