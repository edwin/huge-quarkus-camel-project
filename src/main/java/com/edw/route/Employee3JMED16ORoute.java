...
@ApplicationScoped
public class Employee3JMED16ORoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_3JMED16O/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_3JMED16O")
            .get("/employees_3JMED16O/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_3JMED16O");
        // get one employee
        from("direct:get-employee_3JMED16O")
                .routeId("get-employee-api_3JMED16O")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint3JMED16O_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_3JMED16O")
                .routeId("get-employees-by-firstname-lastname-api_3JMED16O")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint3JMED16O_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
