...
@ApplicationScoped
public class EmployeeWK7HI2TKRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_WK7HI2TK/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_WK7HI2TK")
            .get("/employees_WK7HI2TK/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_WK7HI2TK");
        // get one employee
        from("direct:get-employee_WK7HI2TK")
                .routeId("get-employee-api_WK7HI2TK")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointWK7HI2TK_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_WK7HI2TK")
                .routeId("get-employees-by-firstname-lastname-api_WK7HI2TK")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointWK7HI2TK_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
