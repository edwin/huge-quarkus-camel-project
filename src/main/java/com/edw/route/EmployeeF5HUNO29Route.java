...
@ApplicationScoped
public class EmployeeF5HUNO29Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_F5HUNO29/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_F5HUNO29")
            .get("/employees_F5HUNO29/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_F5HUNO29");
        // get one employee
        from("direct:get-employee_F5HUNO29")
                .routeId("get-employee-api_F5HUNO29")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointF5HUNO29_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_F5HUNO29")
                .routeId("get-employees-by-firstname-lastname-api_F5HUNO29")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointF5HUNO29_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
