...
@ApplicationScoped
public class Employee6Q8WAJPJRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_6Q8WAJPJ/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_6Q8WAJPJ")
            .get("/employees_6Q8WAJPJ/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_6Q8WAJPJ");
        // get one employee
        from("direct:get-employee_6Q8WAJPJ")
                .routeId("get-employee-api_6Q8WAJPJ")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint6Q8WAJPJ_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_6Q8WAJPJ")
                .routeId("get-employees-by-firstname-lastname-api_6Q8WAJPJ")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint6Q8WAJPJ_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
