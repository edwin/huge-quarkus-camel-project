...
@ApplicationScoped
public class EmployeeLOIH3URZRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_LOIH3URZ/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_LOIH3URZ")
            .get("/employees_LOIH3URZ/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_LOIH3URZ");
        // get one employee
        from("direct:get-employee_LOIH3URZ")
                .routeId("get-employee-api_LOIH3URZ")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointLOIH3URZ_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_LOIH3URZ")
                .routeId("get-employees-by-firstname-lastname-api_LOIH3URZ")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointLOIH3URZ_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
