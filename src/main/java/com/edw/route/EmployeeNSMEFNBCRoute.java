...
@ApplicationScoped
public class EmployeeNSMEFNBCRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_NSMEFNBC/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_NSMEFNBC")
            .get("/employees_NSMEFNBC/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_NSMEFNBC");
        // get one employee
        from("direct:get-employee_NSMEFNBC")
                .routeId("get-employee-api_NSMEFNBC")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointNSMEFNBC_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_NSMEFNBC")
                .routeId("get-employees-by-firstname-lastname-api_NSMEFNBC")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointNSMEFNBC_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
