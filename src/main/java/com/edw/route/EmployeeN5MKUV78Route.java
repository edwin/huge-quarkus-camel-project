...
@ApplicationScoped
public class EmployeeN5MKUV78Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_N5MKUV78/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_N5MKUV78")
            .get("/employees_N5MKUV78/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_N5MKUV78");
        // get one employee
        from("direct:get-employee_N5MKUV78")
                .routeId("get-employee-api_N5MKUV78")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointN5MKUV78_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_N5MKUV78")
                .routeId("get-employees-by-firstname-lastname-api_N5MKUV78")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointN5MKUV78_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
