...
@ApplicationScoped
public class EmployeeAOERYEVNRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_AOERYEVN/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_AOERYEVN")
            .get("/employees_AOERYEVN/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_AOERYEVN");
        // get one employee
        from("direct:get-employee_AOERYEVN")
                .routeId("get-employee-api_AOERYEVN")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointAOERYEVN_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_AOERYEVN")
                .routeId("get-employees-by-firstname-lastname-api_AOERYEVN")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointAOERYEVN_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
