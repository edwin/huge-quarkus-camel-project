...
@ApplicationScoped
public class Employee9B1957HFRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_9B1957HF/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_9B1957HF")
            .get("/employees_9B1957HF/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_9B1957HF");
        // get one employee
        from("direct:get-employee_9B1957HF")
                .routeId("get-employee-api_9B1957HF")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint9B1957HF_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_9B1957HF")
                .routeId("get-employees-by-firstname-lastname-api_9B1957HF")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint9B1957HF_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
