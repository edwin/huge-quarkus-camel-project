...
@ApplicationScoped
public class EmployeeG9PF796URoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_G9PF796U/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_G9PF796U")
            .get("/employees_G9PF796U/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_G9PF796U");
        // get one employee
        from("direct:get-employee_G9PF796U")
                .routeId("get-employee-api_G9PF796U")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointG9PF796U_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_G9PF796U")
                .routeId("get-employees-by-firstname-lastname-api_G9PF796U")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointG9PF796U_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
