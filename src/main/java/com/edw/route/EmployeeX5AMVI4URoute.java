...
@ApplicationScoped
public class EmployeeX5AMVI4URoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_X5AMVI4U/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_X5AMVI4U")
            .get("/employees_X5AMVI4U/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_X5AMVI4U");
        // get one employee
        from("direct:get-employee_X5AMVI4U")
                .routeId("get-employee-api_X5AMVI4U")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointX5AMVI4U_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_X5AMVI4U")
                .routeId("get-employees-by-firstname-lastname-api_X5AMVI4U")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointX5AMVI4U_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
