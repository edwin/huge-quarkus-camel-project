...
@ApplicationScoped
public class EmployeeWV0ZUUZ0Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_WV0ZUUZ0/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_WV0ZUUZ0")
            .get("/employees_WV0ZUUZ0/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_WV0ZUUZ0");
        // get one employee
        from("direct:get-employee_WV0ZUUZ0")
                .routeId("get-employee-api_WV0ZUUZ0")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointWV0ZUUZ0_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_WV0ZUUZ0")
                .routeId("get-employees-by-firstname-lastname-api_WV0ZUUZ0")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointWV0ZUUZ0_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
