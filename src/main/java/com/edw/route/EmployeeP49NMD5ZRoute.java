...
@ApplicationScoped
public class EmployeeP49NMD5ZRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_P49NMD5Z/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_P49NMD5Z")
            .get("/employees_P49NMD5Z/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_P49NMD5Z");
        // get one employee
        from("direct:get-employee_P49NMD5Z")
                .routeId("get-employee-api_P49NMD5Z")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointP49NMD5Z_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_P49NMD5Z")
                .routeId("get-employees-by-firstname-lastname-api_P49NMD5Z")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointP49NMD5Z_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
