...
@ApplicationScoped
public class EmployeeUQT6J9MXRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_UQT6J9MX/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_UQT6J9MX")
            .get("/employees_UQT6J9MX/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_UQT6J9MX");
        // get one employee
        from("direct:get-employee_UQT6J9MX")
                .routeId("get-employee-api_UQT6J9MX")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointUQT6J9MX_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_UQT6J9MX")
                .routeId("get-employees-by-firstname-lastname-api_UQT6J9MX")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointUQT6J9MX_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
