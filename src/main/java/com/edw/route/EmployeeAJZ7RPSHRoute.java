...
@ApplicationScoped
public class EmployeeAJZ7RPSHRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_AJZ7RPSH/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_AJZ7RPSH")
            .get("/employees_AJZ7RPSH/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_AJZ7RPSH");
        // get one employee
        from("direct:get-employee_AJZ7RPSH")
                .routeId("get-employee-api_AJZ7RPSH")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointAJZ7RPSH_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_AJZ7RPSH")
                .routeId("get-employees-by-firstname-lastname-api_AJZ7RPSH")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointAJZ7RPSH_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
