...
@ApplicationScoped
public class EmployeeK4LMW6MSRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_K4LMW6MS/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_K4LMW6MS")
            .get("/employees_K4LMW6MS/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_K4LMW6MS");
        // get one employee
        from("direct:get-employee_K4LMW6MS")
                .routeId("get-employee-api_K4LMW6MS")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointK4LMW6MS_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_K4LMW6MS")
                .routeId("get-employees-by-firstname-lastname-api_K4LMW6MS")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointK4LMW6MS_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
