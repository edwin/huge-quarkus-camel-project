...
@ApplicationScoped
public class EmployeeO1I8KAYTRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_O1I8KAYT/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_O1I8KAYT")
            .get("/employees_O1I8KAYT/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_O1I8KAYT");
        // get one employee
        from("direct:get-employee_O1I8KAYT")
                .routeId("get-employee-api_O1I8KAYT")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointO1I8KAYT_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_O1I8KAYT")
                .routeId("get-employees-by-firstname-lastname-api_O1I8KAYT")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointO1I8KAYT_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
