...
@ApplicationScoped
public class Employee0EHHNNKMRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_0EHHNNKM/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_0EHHNNKM")
            .get("/employees_0EHHNNKM/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_0EHHNNKM");
        // get one employee
        from("direct:get-employee_0EHHNNKM")
                .routeId("get-employee-api_0EHHNNKM")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint0EHHNNKM_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_0EHHNNKM")
                .routeId("get-employees-by-firstname-lastname-api_0EHHNNKM")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint0EHHNNKM_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
