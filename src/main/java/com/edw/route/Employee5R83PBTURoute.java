...
@ApplicationScoped
public class Employee5R83PBTURoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_5R83PBTU/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_5R83PBTU")
            .get("/employees_5R83PBTU/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_5R83PBTU");
        // get one employee
        from("direct:get-employee_5R83PBTU")
                .routeId("get-employee-api_5R83PBTU")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint5R83PBTU_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_5R83PBTU")
                .routeId("get-employees-by-firstname-lastname-api_5R83PBTU")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint5R83PBTU_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
