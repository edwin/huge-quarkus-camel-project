...
@ApplicationScoped
public class EmployeeJWGXRX95Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_JWGXRX95/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_JWGXRX95")
            .get("/employees_JWGXRX95/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_JWGXRX95");
        // get one employee
        from("direct:get-employee_JWGXRX95")
                .routeId("get-employee-api_JWGXRX95")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointJWGXRX95_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_JWGXRX95")
                .routeId("get-employees-by-firstname-lastname-api_JWGXRX95")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointJWGXRX95_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
