...
@ApplicationScoped
public class EmployeeEECKU64IRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_EECKU64I/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_EECKU64I")
            .get("/employees_EECKU64I/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_EECKU64I");
        // get one employee
        from("direct:get-employee_EECKU64I")
                .routeId("get-employee-api_EECKU64I")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointEECKU64I_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_EECKU64I")
                .routeId("get-employees-by-firstname-lastname-api_EECKU64I")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointEECKU64I_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
