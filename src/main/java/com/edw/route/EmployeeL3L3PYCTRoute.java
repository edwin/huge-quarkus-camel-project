...
@ApplicationScoped
public class EmployeeL3L3PYCTRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_L3L3PYCT/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_L3L3PYCT")
            .get("/employees_L3L3PYCT/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_L3L3PYCT");
        // get one employee
        from("direct:get-employee_L3L3PYCT")
                .routeId("get-employee-api_L3L3PYCT")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointL3L3PYCT_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_L3L3PYCT")
                .routeId("get-employees-by-firstname-lastname-api_L3L3PYCT")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointL3L3PYCT_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
