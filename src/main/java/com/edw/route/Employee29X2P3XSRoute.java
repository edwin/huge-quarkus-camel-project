...
@ApplicationScoped
public class Employee29X2P3XSRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_29X2P3XS/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_29X2P3XS")
            .get("/employees_29X2P3XS/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_29X2P3XS");
        // get one employee
        from("direct:get-employee_29X2P3XS")
                .routeId("get-employee-api_29X2P3XS")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint29X2P3XS_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_29X2P3XS")
                .routeId("get-employees-by-firstname-lastname-api_29X2P3XS")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint29X2P3XS_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
