...
@ApplicationScoped
public class EmployeeZP1PKK44Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_ZP1PKK44/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_ZP1PKK44")
            .get("/employees_ZP1PKK44/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_ZP1PKK44");
        // get one employee
        from("direct:get-employee_ZP1PKK44")
                .routeId("get-employee-api_ZP1PKK44")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointZP1PKK44_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_ZP1PKK44")
                .routeId("get-employees-by-firstname-lastname-api_ZP1PKK44")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointZP1PKK44_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
