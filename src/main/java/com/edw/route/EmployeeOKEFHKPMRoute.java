...
@ApplicationScoped
public class EmployeeOKEFHKPMRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_OKEFHKPM/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_OKEFHKPM")
            .get("/employees_OKEFHKPM/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_OKEFHKPM");
        // get one employee
        from("direct:get-employee_OKEFHKPM")
                .routeId("get-employee-api_OKEFHKPM")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointOKEFHKPM_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_OKEFHKPM")
                .routeId("get-employees-by-firstname-lastname-api_OKEFHKPM")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointOKEFHKPM_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
