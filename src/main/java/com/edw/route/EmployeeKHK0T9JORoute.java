...
@ApplicationScoped
public class EmployeeKHK0T9JORoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_KHK0T9JO/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_KHK0T9JO")
            .get("/employees_KHK0T9JO/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_KHK0T9JO");
        // get one employee
        from("direct:get-employee_KHK0T9JO")
                .routeId("get-employee-api_KHK0T9JO")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointKHK0T9JO_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_KHK0T9JO")
                .routeId("get-employees-by-firstname-lastname-api_KHK0T9JO")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointKHK0T9JO_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
