...
@ApplicationScoped
public class EmployeeYWJYSY7LRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_YWJYSY7L/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_YWJYSY7L")
            .get("/employees_YWJYSY7L/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_YWJYSY7L");
        // get one employee
        from("direct:get-employee_YWJYSY7L")
                .routeId("get-employee-api_YWJYSY7L")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointYWJYSY7L_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_YWJYSY7L")
                .routeId("get-employees-by-firstname-lastname-api_YWJYSY7L")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointYWJYSY7L_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
