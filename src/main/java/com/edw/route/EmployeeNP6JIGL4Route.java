...
@ApplicationScoped
public class EmployeeNP6JIGL4Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_NP6JIGL4/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_NP6JIGL4")
            .get("/employees_NP6JIGL4/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_NP6JIGL4");
        // get one employee
        from("direct:get-employee_NP6JIGL4")
                .routeId("get-employee-api_NP6JIGL4")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointNP6JIGL4_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_NP6JIGL4")
                .routeId("get-employees-by-firstname-lastname-api_NP6JIGL4")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointNP6JIGL4_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
