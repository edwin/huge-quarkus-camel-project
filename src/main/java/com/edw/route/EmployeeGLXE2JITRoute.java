...
@ApplicationScoped
public class EmployeeGLXE2JITRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_GLXE2JIT/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_GLXE2JIT")
            .get("/employees_GLXE2JIT/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_GLXE2JIT");
        // get one employee
        from("direct:get-employee_GLXE2JIT")
                .routeId("get-employee-api_GLXE2JIT")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointGLXE2JIT_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_GLXE2JIT")
                .routeId("get-employees-by-firstname-lastname-api_GLXE2JIT")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointGLXE2JIT_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
