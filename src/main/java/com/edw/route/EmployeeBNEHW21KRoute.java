...
@ApplicationScoped
public class EmployeeBNEHW21KRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_BNEHW21K/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_BNEHW21K")
            .get("/employees_BNEHW21K/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_BNEHW21K");
        // get one employee
        from("direct:get-employee_BNEHW21K")
                .routeId("get-employee-api_BNEHW21K")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointBNEHW21K_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_BNEHW21K")
                .routeId("get-employees-by-firstname-lastname-api_BNEHW21K")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointBNEHW21K_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
