...
@ApplicationScoped
public class EmployeeRWXNF38DRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_RWXNF38D/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_RWXNF38D")
            .get("/employees_RWXNF38D/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_RWXNF38D");
        // get one employee
        from("direct:get-employee_RWXNF38D")
                .routeId("get-employee-api_RWXNF38D")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointRWXNF38D_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_RWXNF38D")
                .routeId("get-employees-by-firstname-lastname-api_RWXNF38D")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointRWXNF38D_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
