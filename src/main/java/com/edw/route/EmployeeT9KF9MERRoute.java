...
@ApplicationScoped
public class EmployeeT9KF9MERRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_T9KF9MER/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_T9KF9MER")
            .get("/employees_T9KF9MER/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_T9KF9MER");
        // get one employee
        from("direct:get-employee_T9KF9MER")
                .routeId("get-employee-api_T9KF9MER")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointT9KF9MER_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_T9KF9MER")
                .routeId("get-employees-by-firstname-lastname-api_T9KF9MER")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointT9KF9MER_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
