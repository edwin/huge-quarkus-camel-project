...
@ApplicationScoped
public class EmployeeZBUUTF5QRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_ZBUUTF5Q/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_ZBUUTF5Q")
            .get("/employees_ZBUUTF5Q/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_ZBUUTF5Q");
        // get one employee
        from("direct:get-employee_ZBUUTF5Q")
                .routeId("get-employee-api_ZBUUTF5Q")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointZBUUTF5Q_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_ZBUUTF5Q")
                .routeId("get-employees-by-firstname-lastname-api_ZBUUTF5Q")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointZBUUTF5Q_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
