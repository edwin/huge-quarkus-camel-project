...
@ApplicationScoped
public class EmployeeVRO5BTW4Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_VRO5BTW4/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_VRO5BTW4")
            .get("/employees_VRO5BTW4/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_VRO5BTW4");
        // get one employee
        from("direct:get-employee_VRO5BTW4")
                .routeId("get-employee-api_VRO5BTW4")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointVRO5BTW4_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_VRO5BTW4")
                .routeId("get-employees-by-firstname-lastname-api_VRO5BTW4")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointVRO5BTW4_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
