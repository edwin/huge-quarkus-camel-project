...
@ApplicationScoped
public class Employee334N4CRNRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_334N4CRN/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_334N4CRN")
            .get("/employees_334N4CRN/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_334N4CRN");
        // get one employee
        from("direct:get-employee_334N4CRN")
                .routeId("get-employee-api_334N4CRN")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint334N4CRN_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_334N4CRN")
                .routeId("get-employees-by-firstname-lastname-api_334N4CRN")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint334N4CRN_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
