...
@ApplicationScoped
public class EmployeeI8EXXJ9FRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_I8EXXJ9F/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_I8EXXJ9F")
            .get("/employees_I8EXXJ9F/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_I8EXXJ9F");
        // get one employee
        from("direct:get-employee_I8EXXJ9F")
                .routeId("get-employee-api_I8EXXJ9F")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointI8EXXJ9F_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_I8EXXJ9F")
                .routeId("get-employees-by-firstname-lastname-api_I8EXXJ9F")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointI8EXXJ9F_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
