...
@ApplicationScoped
public class Employee6O04V5MYRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_6O04V5MY/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_6O04V5MY")
            .get("/employees_6O04V5MY/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_6O04V5MY");
        // get one employee
        from("direct:get-employee_6O04V5MY")
                .routeId("get-employee-api_6O04V5MY")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint6O04V5MY_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_6O04V5MY")
                .routeId("get-employees-by-firstname-lastname-api_6O04V5MY")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint6O04V5MY_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
