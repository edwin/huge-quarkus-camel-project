...
@ApplicationScoped
public class EmployeeCA2CF4Y1Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_CA2CF4Y1/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_CA2CF4Y1")
            .get("/employees_CA2CF4Y1/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_CA2CF4Y1");
        // get one employee
        from("direct:get-employee_CA2CF4Y1")
                .routeId("get-employee-api_CA2CF4Y1")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointCA2CF4Y1_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_CA2CF4Y1")
                .routeId("get-employees-by-firstname-lastname-api_CA2CF4Y1")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointCA2CF4Y1_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
