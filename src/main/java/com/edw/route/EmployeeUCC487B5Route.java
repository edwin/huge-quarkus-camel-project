...
@ApplicationScoped
public class EmployeeUCC487B5Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_UCC487B5/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_UCC487B5")
            .get("/employees_UCC487B5/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_UCC487B5");
        // get one employee
        from("direct:get-employee_UCC487B5")
                .routeId("get-employee-api_UCC487B5")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointUCC487B5_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_UCC487B5")
                .routeId("get-employees-by-firstname-lastname-api_UCC487B5")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointUCC487B5_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
