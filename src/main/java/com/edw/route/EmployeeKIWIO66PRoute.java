...
@ApplicationScoped
public class EmployeeKIWIO66PRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_KIWIO66P/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_KIWIO66P")
            .get("/employees_KIWIO66P/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_KIWIO66P");
        // get one employee
        from("direct:get-employee_KIWIO66P")
                .routeId("get-employee-api_KIWIO66P")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointKIWIO66P_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_KIWIO66P")
                .routeId("get-employees-by-firstname-lastname-api_KIWIO66P")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointKIWIO66P_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
