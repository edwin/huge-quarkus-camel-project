...
@ApplicationScoped
public class EmployeeFJGZTX24Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_FJGZTX24/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_FJGZTX24")
            .get("/employees_FJGZTX24/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_FJGZTX24");
        // get one employee
        from("direct:get-employee_FJGZTX24")
                .routeId("get-employee-api_FJGZTX24")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointFJGZTX24_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_FJGZTX24")
                .routeId("get-employees-by-firstname-lastname-api_FJGZTX24")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointFJGZTX24_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
