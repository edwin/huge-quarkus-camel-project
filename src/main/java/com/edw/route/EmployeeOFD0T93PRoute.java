...
@ApplicationScoped
public class EmployeeOFD0T93PRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_OFD0T93P/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_OFD0T93P")
            .get("/employees_OFD0T93P/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_OFD0T93P");
        // get one employee
        from("direct:get-employee_OFD0T93P")
                .routeId("get-employee-api_OFD0T93P")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointOFD0T93P_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_OFD0T93P")
                .routeId("get-employees-by-firstname-lastname-api_OFD0T93P")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointOFD0T93P_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
