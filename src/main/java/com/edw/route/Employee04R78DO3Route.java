...
@ApplicationScoped
public class Employee04R78DO3Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_04R78DO3/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_04R78DO3")
            .get("/employees_04R78DO3/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_04R78DO3");
        // get one employee
        from("direct:get-employee_04R78DO3")
                .routeId("get-employee-api_04R78DO3")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint04R78DO3_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_04R78DO3")
                .routeId("get-employees-by-firstname-lastname-api_04R78DO3")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint04R78DO3_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
