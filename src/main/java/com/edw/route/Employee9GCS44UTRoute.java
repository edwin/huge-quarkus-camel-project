...
@ApplicationScoped
public class Employee9GCS44UTRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_9GCS44UT/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_9GCS44UT")
            .get("/employees_9GCS44UT/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_9GCS44UT");
        // get one employee
        from("direct:get-employee_9GCS44UT")
                .routeId("get-employee-api_9GCS44UT")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint9GCS44UT_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_9GCS44UT")
                .routeId("get-employees-by-firstname-lastname-api_9GCS44UT")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint9GCS44UT_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
