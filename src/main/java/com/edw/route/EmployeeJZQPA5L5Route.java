...
@ApplicationScoped
public class EmployeeJZQPA5L5Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_JZQPA5L5/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_JZQPA5L5")
            .get("/employees_JZQPA5L5/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_JZQPA5L5");
        // get one employee
        from("direct:get-employee_JZQPA5L5")
                .routeId("get-employee-api_JZQPA5L5")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointJZQPA5L5_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_JZQPA5L5")
                .routeId("get-employees-by-firstname-lastname-api_JZQPA5L5")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointJZQPA5L5_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
