...
@ApplicationScoped
public class Employee97ZCLZ5JRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_97ZCLZ5J/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_97ZCLZ5J")
            .get("/employees_97ZCLZ5J/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_97ZCLZ5J");
        // get one employee
        from("direct:get-employee_97ZCLZ5J")
                .routeId("get-employee-api_97ZCLZ5J")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint97ZCLZ5J_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_97ZCLZ5J")
                .routeId("get-employees-by-firstname-lastname-api_97ZCLZ5J")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint97ZCLZ5J_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
