...
@ApplicationScoped
public class EmployeeYX8LGU2HRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_YX8LGU2H/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_YX8LGU2H")
            .get("/employees_YX8LGU2H/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_YX8LGU2H");
        // get one employee
        from("direct:get-employee_YX8LGU2H")
                .routeId("get-employee-api_YX8LGU2H")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointYX8LGU2H_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_YX8LGU2H")
                .routeId("get-employees-by-firstname-lastname-api_YX8LGU2H")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointYX8LGU2H_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
