...
@ApplicationScoped
public class EmployeeWGQUGT08Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_WGQUGT08/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_WGQUGT08")
            .get("/employees_WGQUGT08/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_WGQUGT08");
        // get one employee
        from("direct:get-employee_WGQUGT08")
                .routeId("get-employee-api_WGQUGT08")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointWGQUGT08_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_WGQUGT08")
                .routeId("get-employees-by-firstname-lastname-api_WGQUGT08")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointWGQUGT08_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
