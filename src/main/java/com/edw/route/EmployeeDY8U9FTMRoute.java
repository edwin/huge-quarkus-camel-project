...
@ApplicationScoped
public class EmployeeDY8U9FTMRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_DY8U9FTM/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_DY8U9FTM")
            .get("/employees_DY8U9FTM/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_DY8U9FTM");
        // get one employee
        from("direct:get-employee_DY8U9FTM")
                .routeId("get-employee-api_DY8U9FTM")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointDY8U9FTM_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_DY8U9FTM")
                .routeId("get-employees-by-firstname-lastname-api_DY8U9FTM")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointDY8U9FTM_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
