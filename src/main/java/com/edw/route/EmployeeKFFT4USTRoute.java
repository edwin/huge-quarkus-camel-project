...
@ApplicationScoped
public class EmployeeKFFT4USTRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_KFFT4UST/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_KFFT4UST")
            .get("/employees_KFFT4UST/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_KFFT4UST");
        // get one employee
        from("direct:get-employee_KFFT4UST")
                .routeId("get-employee-api_KFFT4UST")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointKFFT4UST_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_KFFT4UST")
                .routeId("get-employees-by-firstname-lastname-api_KFFT4UST")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointKFFT4UST_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
