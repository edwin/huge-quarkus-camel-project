...
@ApplicationScoped
public class Employee73BGLZ89Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_73BGLZ89/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_73BGLZ89")
            .get("/employees_73BGLZ89/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_73BGLZ89");
        // get one employee
        from("direct:get-employee_73BGLZ89")
                .routeId("get-employee-api_73BGLZ89")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint73BGLZ89_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_73BGLZ89")
                .routeId("get-employees-by-firstname-lastname-api_73BGLZ89")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint73BGLZ89_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
