...
@ApplicationScoped
public class EmployeeMTEA19CDRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_MTEA19CD/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_MTEA19CD")
            .get("/employees_MTEA19CD/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_MTEA19CD");
        // get one employee
        from("direct:get-employee_MTEA19CD")
                .routeId("get-employee-api_MTEA19CD")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointMTEA19CD_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_MTEA19CD")
                .routeId("get-employees-by-firstname-lastname-api_MTEA19CD")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointMTEA19CD_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
