...
@ApplicationScoped
public class EmployeeIYTLIM27Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_IYTLIM27/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_IYTLIM27")
            .get("/employees_IYTLIM27/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_IYTLIM27");
        // get one employee
        from("direct:get-employee_IYTLIM27")
                .routeId("get-employee-api_IYTLIM27")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointIYTLIM27_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_IYTLIM27")
                .routeId("get-employees-by-firstname-lastname-api_IYTLIM27")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointIYTLIM27_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
