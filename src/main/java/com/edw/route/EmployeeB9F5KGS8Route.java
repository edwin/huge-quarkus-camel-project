...
@ApplicationScoped
public class EmployeeB9F5KGS8Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_B9F5KGS8/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_B9F5KGS8")
            .get("/employees_B9F5KGS8/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_B9F5KGS8");
        // get one employee
        from("direct:get-employee_B9F5KGS8")
                .routeId("get-employee-api_B9F5KGS8")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointB9F5KGS8_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_B9F5KGS8")
                .routeId("get-employees-by-firstname-lastname-api_B9F5KGS8")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointB9F5KGS8_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
