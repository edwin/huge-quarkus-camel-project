...
@ApplicationScoped
public class EmployeeTJ4NUDLJRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_TJ4NUDLJ/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_TJ4NUDLJ")
            .get("/employees_TJ4NUDLJ/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_TJ4NUDLJ");
        // get one employee
        from("direct:get-employee_TJ4NUDLJ")
                .routeId("get-employee-api_TJ4NUDLJ")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointTJ4NUDLJ_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_TJ4NUDLJ")
                .routeId("get-employees-by-firstname-lastname-api_TJ4NUDLJ")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointTJ4NUDLJ_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
