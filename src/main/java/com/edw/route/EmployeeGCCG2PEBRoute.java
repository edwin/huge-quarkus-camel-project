...
@ApplicationScoped
public class EmployeeGCCG2PEBRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_GCCG2PEB/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_GCCG2PEB")
            .get("/employees_GCCG2PEB/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_GCCG2PEB");
        // get one employee
        from("direct:get-employee_GCCG2PEB")
                .routeId("get-employee-api_GCCG2PEB")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointGCCG2PEB_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_GCCG2PEB")
                .routeId("get-employees-by-firstname-lastname-api_GCCG2PEB")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointGCCG2PEB_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
