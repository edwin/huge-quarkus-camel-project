...
@ApplicationScoped
public class EmployeePUO5BFPERoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_PUO5BFPE/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_PUO5BFPE")
            .get("/employees_PUO5BFPE/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_PUO5BFPE");
        // get one employee
        from("direct:get-employee_PUO5BFPE")
                .routeId("get-employee-api_PUO5BFPE")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointPUO5BFPE_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_PUO5BFPE")
                .routeId("get-employees-by-firstname-lastname-api_PUO5BFPE")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointPUO5BFPE_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
