...
@ApplicationScoped
public class EmployeeUISLY5OARoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_UISLY5OA/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_UISLY5OA")
            .get("/employees_UISLY5OA/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_UISLY5OA");
        // get one employee
        from("direct:get-employee_UISLY5OA")
                .routeId("get-employee-api_UISLY5OA")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointUISLY5OA_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_UISLY5OA")
                .routeId("get-employees-by-firstname-lastname-api_UISLY5OA")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointUISLY5OA_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
