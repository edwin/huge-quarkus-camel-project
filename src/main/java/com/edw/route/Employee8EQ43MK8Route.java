...
@ApplicationScoped
public class Employee8EQ43MK8Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_8EQ43MK8/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_8EQ43MK8")
            .get("/employees_8EQ43MK8/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_8EQ43MK8");
        // get one employee
        from("direct:get-employee_8EQ43MK8")
                .routeId("get-employee-api_8EQ43MK8")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint8EQ43MK8_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_8EQ43MK8")
                .routeId("get-employees-by-firstname-lastname-api_8EQ43MK8")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint8EQ43MK8_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
