...
@ApplicationScoped
public class EmployeeT890GHA3Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_T890GHA3/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_T890GHA3")
            .get("/employees_T890GHA3/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_T890GHA3");
        // get one employee
        from("direct:get-employee_T890GHA3")
                .routeId("get-employee-api_T890GHA3")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointT890GHA3_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_T890GHA3")
                .routeId("get-employees-by-firstname-lastname-api_T890GHA3")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointT890GHA3_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
