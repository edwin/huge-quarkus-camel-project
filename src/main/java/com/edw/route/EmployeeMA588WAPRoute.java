...
@ApplicationScoped
public class EmployeeMA588WAPRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_MA588WAP/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_MA588WAP")
            .get("/employees_MA588WAP/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_MA588WAP");
        // get one employee
        from("direct:get-employee_MA588WAP")
                .routeId("get-employee-api_MA588WAP")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointMA588WAP_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_MA588WAP")
                .routeId("get-employees-by-firstname-lastname-api_MA588WAP")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointMA588WAP_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
