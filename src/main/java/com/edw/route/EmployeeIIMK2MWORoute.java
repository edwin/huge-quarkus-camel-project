...
@ApplicationScoped
public class EmployeeIIMK2MWORoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_IIMK2MWO/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_IIMK2MWO")
            .get("/employees_IIMK2MWO/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_IIMK2MWO");
        // get one employee
        from("direct:get-employee_IIMK2MWO")
                .routeId("get-employee-api_IIMK2MWO")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointIIMK2MWO_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_IIMK2MWO")
                .routeId("get-employees-by-firstname-lastname-api_IIMK2MWO")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointIIMK2MWO_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
