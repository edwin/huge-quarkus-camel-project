...
@ApplicationScoped
public class Employee4PY5287ZRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_4PY5287Z/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_4PY5287Z")
            .get("/employees_4PY5287Z/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_4PY5287Z");
        // get one employee
        from("direct:get-employee_4PY5287Z")
                .routeId("get-employee-api_4PY5287Z")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint4PY5287Z_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_4PY5287Z")
                .routeId("get-employees-by-firstname-lastname-api_4PY5287Z")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint4PY5287Z_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
