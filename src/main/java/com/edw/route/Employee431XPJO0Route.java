...
@ApplicationScoped
public class Employee431XPJO0Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_431XPJO0/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_431XPJO0")
            .get("/employees_431XPJO0/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_431XPJO0");
        // get one employee
        from("direct:get-employee_431XPJO0")
                .routeId("get-employee-api_431XPJO0")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint431XPJO0_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_431XPJO0")
                .routeId("get-employees-by-firstname-lastname-api_431XPJO0")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint431XPJO0_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
