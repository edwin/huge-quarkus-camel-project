...
@ApplicationScoped
public class EmployeeGMISLERARoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_GMISLERA/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_GMISLERA")
            .get("/employees_GMISLERA/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_GMISLERA");
        // get one employee
        from("direct:get-employee_GMISLERA")
                .routeId("get-employee-api_GMISLERA")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointGMISLERA_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_GMISLERA")
                .routeId("get-employees-by-firstname-lastname-api_GMISLERA")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointGMISLERA_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
