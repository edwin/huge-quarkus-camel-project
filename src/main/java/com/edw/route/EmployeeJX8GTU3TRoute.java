...
@ApplicationScoped
public class EmployeeJX8GTU3TRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_JX8GTU3T/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_JX8GTU3T")
            .get("/employees_JX8GTU3T/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_JX8GTU3T");
        // get one employee
        from("direct:get-employee_JX8GTU3T")
                .routeId("get-employee-api_JX8GTU3T")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointJX8GTU3T_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_JX8GTU3T")
                .routeId("get-employees-by-firstname-lastname-api_JX8GTU3T")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointJX8GTU3T_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
