...
@ApplicationScoped
public class Employee3VUAB1AJRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_3VUAB1AJ/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_3VUAB1AJ")
            .get("/employees_3VUAB1AJ/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_3VUAB1AJ");
        // get one employee
        from("direct:get-employee_3VUAB1AJ")
                .routeId("get-employee-api_3VUAB1AJ")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint3VUAB1AJ_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_3VUAB1AJ")
                .routeId("get-employees-by-firstname-lastname-api_3VUAB1AJ")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint3VUAB1AJ_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
