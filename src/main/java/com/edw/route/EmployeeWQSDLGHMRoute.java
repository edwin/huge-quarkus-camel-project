...
@ApplicationScoped
public class EmployeeWQSDLGHMRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_WQSDLGHM/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_WQSDLGHM")
            .get("/employees_WQSDLGHM/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_WQSDLGHM");
        // get one employee
        from("direct:get-employee_WQSDLGHM")
                .routeId("get-employee-api_WQSDLGHM")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointWQSDLGHM_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_WQSDLGHM")
                .routeId("get-employees-by-firstname-lastname-api_WQSDLGHM")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointWQSDLGHM_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
