...
@ApplicationScoped
public class Employee9X0F40B4Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_9X0F40B4/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_9X0F40B4")
            .get("/employees_9X0F40B4/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_9X0F40B4");
        // get one employee
        from("direct:get-employee_9X0F40B4")
                .routeId("get-employee-api_9X0F40B4")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint9X0F40B4_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_9X0F40B4")
                .routeId("get-employees-by-firstname-lastname-api_9X0F40B4")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint9X0F40B4_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
