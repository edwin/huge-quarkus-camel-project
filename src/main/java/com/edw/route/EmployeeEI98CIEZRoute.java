...
@ApplicationScoped
public class EmployeeEI98CIEZRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_EI98CIEZ/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_EI98CIEZ")
            .get("/employees_EI98CIEZ/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_EI98CIEZ");
        // get one employee
        from("direct:get-employee_EI98CIEZ")
                .routeId("get-employee-api_EI98CIEZ")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointEI98CIEZ_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_EI98CIEZ")
                .routeId("get-employees-by-firstname-lastname-api_EI98CIEZ")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointEI98CIEZ_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
