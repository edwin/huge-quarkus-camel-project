...
@ApplicationScoped
public class EmployeeZDWZUKSARoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_ZDWZUKSA/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_ZDWZUKSA")
            .get("/employees_ZDWZUKSA/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_ZDWZUKSA");
        // get one employee
        from("direct:get-employee_ZDWZUKSA")
                .routeId("get-employee-api_ZDWZUKSA")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointZDWZUKSA_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_ZDWZUKSA")
                .routeId("get-employees-by-firstname-lastname-api_ZDWZUKSA")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointZDWZUKSA_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
