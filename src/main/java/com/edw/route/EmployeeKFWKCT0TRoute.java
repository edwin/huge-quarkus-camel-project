...
@ApplicationScoped
public class EmployeeKFWKCT0TRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_KFWKCT0T/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_KFWKCT0T")
            .get("/employees_KFWKCT0T/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_KFWKCT0T");
        // get one employee
        from("direct:get-employee_KFWKCT0T")
                .routeId("get-employee-api_KFWKCT0T")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointKFWKCT0T_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_KFWKCT0T")
                .routeId("get-employees-by-firstname-lastname-api_KFWKCT0T")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointKFWKCT0T_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
