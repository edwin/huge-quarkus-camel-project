...
@ApplicationScoped
public class EmployeeMYLE4L98Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_MYLE4L98/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_MYLE4L98")
            .get("/employees_MYLE4L98/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_MYLE4L98");
        // get one employee
        from("direct:get-employee_MYLE4L98")
                .routeId("get-employee-api_MYLE4L98")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointMYLE4L98_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_MYLE4L98")
                .routeId("get-employees-by-firstname-lastname-api_MYLE4L98")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointMYLE4L98_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
