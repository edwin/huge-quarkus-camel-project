...
@ApplicationScoped
public class EmployeeYKAPTFKARoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_YKAPTFKA/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_YKAPTFKA")
            .get("/employees_YKAPTFKA/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_YKAPTFKA");
        // get one employee
        from("direct:get-employee_YKAPTFKA")
                .routeId("get-employee-api_YKAPTFKA")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointYKAPTFKA_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_YKAPTFKA")
                .routeId("get-employees-by-firstname-lastname-api_YKAPTFKA")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointYKAPTFKA_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
