...
@ApplicationScoped
public class EmployeeL1Y8QUYJRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_L1Y8QUYJ/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_L1Y8QUYJ")
            .get("/employees_L1Y8QUYJ/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_L1Y8QUYJ");
        // get one employee
        from("direct:get-employee_L1Y8QUYJ")
                .routeId("get-employee-api_L1Y8QUYJ")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointL1Y8QUYJ_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_L1Y8QUYJ")
                .routeId("get-employees-by-firstname-lastname-api_L1Y8QUYJ")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointL1Y8QUYJ_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
