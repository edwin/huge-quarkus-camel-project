...
@ApplicationScoped
public class Employee8BNO0TNZRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_8BNO0TNZ/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_8BNO0TNZ")
            .get("/employees_8BNO0TNZ/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_8BNO0TNZ");
        // get one employee
        from("direct:get-employee_8BNO0TNZ")
                .routeId("get-employee-api_8BNO0TNZ")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint8BNO0TNZ_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_8BNO0TNZ")
                .routeId("get-employees-by-firstname-lastname-api_8BNO0TNZ")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint8BNO0TNZ_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
