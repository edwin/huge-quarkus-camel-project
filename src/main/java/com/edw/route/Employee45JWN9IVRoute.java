...
@ApplicationScoped
public class Employee45JWN9IVRoute extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_45JWN9IV/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_45JWN9IV")
            .get("/employees_45JWN9IV/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_45JWN9IV");
        // get one employee
        from("direct:get-employee_45JWN9IV")
                .routeId("get-employee-api_45JWN9IV")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint45JWN9IV_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_45JWN9IV")
                .routeId("get-employees-by-firstname-lastname-api_45JWN9IV")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpoint45JWN9IV_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
