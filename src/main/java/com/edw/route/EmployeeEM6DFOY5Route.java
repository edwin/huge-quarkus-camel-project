...
@ApplicationScoped
public class EmployeeEM6DFOY5Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_EM6DFOY5/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_EM6DFOY5")
            .get("/employees_EM6DFOY5/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_EM6DFOY5");
        // get one employee
        from("direct:get-employee_EM6DFOY5")
                .routeId("get-employee-api_EM6DFOY5")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointEM6DFOY5_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_EM6DFOY5")
                .routeId("get-employees-by-firstname-lastname-api_EM6DFOY5")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointEM6DFOY5_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
