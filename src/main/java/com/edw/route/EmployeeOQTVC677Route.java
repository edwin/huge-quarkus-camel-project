...
@ApplicationScoped
public class EmployeeOQTVC677Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_OQTVC677/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_OQTVC677")
            .get("/employees_OQTVC677/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_OQTVC677");
        // get one employee
        from("direct:get-employee_OQTVC677")
                .routeId("get-employee-api_OQTVC677")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointOQTVC677_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_OQTVC677")
                .routeId("get-employees-by-firstname-lastname-api_OQTVC677")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointOQTVC677_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
