...
@ApplicationScoped
public class EmployeeA500RJ80Route extends RouteBuilder {
    @Override
    public void configure() throws Exception {
        ...
        rest("/api")
            .get("/employees_A500RJ80/{id}")
                .produces("application/json")
                    .type(EmployeeResponse.class)
                        .to("direct:get-employee_A500RJ80")
            .get("/employees_A500RJ80/{firstname}/{lastname}")
                .produces("application/json")
                    .type(EmployeesResponse.class)
                        .to("direct:get-employees-by-firstname-lastname_A500RJ80");
        // get one employee
        from("direct:get-employee_A500RJ80")
                .routeId("get-employee-api_A500RJ80")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointA500RJ80_getEmployeeById")
        ...
        from("direct:get-employees-by-firstname-lastname_A500RJ80")
                .routeId("get-employees-by-firstname-lastname-api_A500RJ80")
                ...
                // soap request
                .to("cxf:bean:employeeServiceEndpointA500RJ80_getEmployeesByName")
                // process the response
                .process(exchange -> {
                    exchange.getIn().getHeaders().clear();
